	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="40%"class="title_left">
	  	<h1>		
	  		<img src="<c:url value='/images/egovframework/cop/cmy/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="">&nbsp;커뮤니티 목록
	  	</h1>
	  </td>
	  <th >
	  </th>
	  ...
	  <th width="10%">
	   <table border="0" cellspacing="0" cellpadding="0">
	    <tr> 
	      ...
	      <td class="btnBackground" nowrap><input type="submit" value="<spring:message code="button.inquire" />" onclick="fn_egov_select_cmmntyInfs('1'); return false;" style="height:20px;width:26px;padding:0px 0px 0px 0px;" ></td>
	      <td><img src="<c:out value="${ImgUrl}"/>btn/bu2_right.gif" alt="버튼이미지" title="버튼이미지" width="8" height="20"></td>
	      <td>&nbsp;</td>
	      <td><img src="<c:out value="${ImgUrl}"/>btn/bu2_left.gif" alt="버튼이미지" title="버튼이미지" width="8" height="20"></td>
	      <td class="btnBackground" nowrap><a href="<c:url value='/cop/cmy/addCmmntyInf.do'/>"><spring:message code="button.create" /></a></td>
	      <td><img src="<c:out value="${ImgUrl}"/>btn/bu2_right.gif" alt="버튼이미지" title="버튼이미지" width="8" height="20"></td>
	      <td>&nbsp;</td>  
	    </tr>
	   </table>
