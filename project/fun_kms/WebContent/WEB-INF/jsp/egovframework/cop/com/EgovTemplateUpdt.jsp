	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="100%"class="title_left">
	  	<h1>		
	  		<img src="<c:url value='/images/egovframework/cop/com/icon/tit_icon.gif' />" width="16" height="16" hspace="3" alt="">&nbsp;템플릿 정보수정
	  	</h1>
	  </td>
	 </tr>
	</table>
	    ...
	    <td>
	   	<select name="tmplatSeCode" class="select" onchange="fn_egov_selectTmplatType(this)">
			...
			<c:forEach var="result" items="${resultList}" varStatus="status">
				<c:choose>
					<c:when test="${TemplateInfVO.tmplatSeCode == result.code}">
						<option value="${result.code}"  selected="selected">${result.codeNm}</option>
					<c:otherwise>
