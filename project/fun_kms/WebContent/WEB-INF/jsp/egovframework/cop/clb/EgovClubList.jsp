	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="40%"class="title_left">
	  	<h1>		
	  		<img src="<c:url value='/images/egovframework/cop/clb/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="">&nbsp;동호회 목록
	  	</h1>
	  </td>
	  <th >
	  </th>
	  ...
	  <td width="35%">
	    <input name="searchWrd" type="text" size="35" value='<c:out value="${searchVO.searchWrd}"/>'  title="검색어 입력" maxlength="35" > 
	  </td>
	  <th width="10%">
