...
<script type="text/javascript">
	function fn_egov_update_scrap() {
		...
		if (confirm('<spring:message code="common.update.msg" />')) {
			document.scrap.action = "<c:url value='/cop/bbs/updateScrap.do'/>";
	...
	function fn_egov_select_scrap(){
		...
		form.action = "<c:url value='/cop/bbs/selectScrapList.do'/>";
		form.submit();	
	}	
</script>
<title>스크랩 수정</title>
...
<form:form commandName="scrap" name="scrap" method="post" action="${pageContext.request.contextPath}/cop/bbs/updateScrap.do">
...
<c:out value="${board.nttCn}" escapeXml="false" />	
	...
	<tr>
      ...
      <td width="10"></td>
      <td><span class="button"><a href="<c:url value='/cop/bbs/selectScrapList.do'/>?pageIndex=1" onclick="fn_egov_select_scrap(); return false;"><spring:message code="button.list" /></a></span></td>
	</tr>
	</table>
	</div>
</div>
