...
function fn_egov_insert_commentList() {
	...
	if (confirm('<spring:message code="common.regist.msg" />')) {
		document.frm.action = "<c:url value='/cop/bbs${prefix}/insertComment.do'/>";
		document.frm.submit();
	}				
}
...
function fn_egov_updt_commentList() {
	...
	if (confirm('<spring:message code="common.update.msg" />')) {
		...
		document.frm.action = "<c:url value='/cop/bbs${prefix}/updateComment.do'/>";
		document.frm.submit();
	}
}
...
function fn_egov_deleteCommentList(commentNo, index) {
	...
	if (confirm('<spring:message code="common.delete.msg" />')) {
		document.frm.modified.value = "true";
		document.frm.commentNo.value = commentNo;
		document.frm.action = "<c:url value='/cop/bbs${prefix}/deleteComment.do'/>";
		document.frm.submit();
	}
}
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="generalTable">
	...
	<tr> 
	    ...
	    <img src="<c:url value='/images/egovframework/cop/bbs/icon/required.gif' />" width="15" height="15" alt="required"></th>
	    <td>
	      <textarea name="commentCn" class="textarea"  cols="50" rows="4"  style="width:100%;"><c:out value="${searchVO.commentCn}" /></textarea> 
	  ...
	  <c:if test="${anonymous == 'true'}">
		  <tr> 
		    ...
		    <img src="<c:url value='/images/egovframework/cop/bbs/icon/required.gif' />" width="15" height="15" alt="required"></th>
		    <td colspan="3">
		      <input name="commentPassword" type="password" size="20" value="" maxlength="20" >
		    </td>
		  </tr>	  	
	  	</c:if>
	</table>
