...
<form name="scrapForm" method="post" action="<c:url value='/cop/bbs/selectScrap.do'/>">
	 ...
	 <tbody>
		 <c:forEach var="result" items="${resultList}" varStatus="status">
		  <tr>
		    ...
		    <td class="lt_text6">		    
			<span class="link"><input type="text" value="<c:out value="${result.scrapNm}"/>" onclick="javascript:fn_egov_inqire_scrap('<c:out value="${result.scrapId}"/>'); return false;"></span>
		    </td>
		  </tr>
		 </c:forEach>	  
