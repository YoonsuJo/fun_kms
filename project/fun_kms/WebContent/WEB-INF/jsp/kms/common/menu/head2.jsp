...
<!--				${user.attendCdPrint}${user.attendCdPrintSimple}-->
			...
			<ul id="gnbmenu">
				...
				<li><a href="${rootPath}/cooperation/selectDayReport.do" id="top1m1"><img src="${imagePath}/inc/gnb/gnb01.gif" alt="공통업무" /></a>
					<div id="snbmenu_m1">
						<ul>
...
<c:choose>
	...
	<c:when test="${(user.orgnztId == 'ORGAN_00000000000031') || (user.orgnztId == 'ORGAN_00000000000032') }"> <!-- 솔루션사업팀, 서비스사업팀 -->
									<li id="snbmenu05m5"><a href="${rootPath}/fund/chckOrgSalesList.do">채권관리</a></li>
									<li id="snbmenu06m4"><a href="${rootPath}/support/stockL.do">재고 현황</a></li>
	</c:when>
	<c:otherwise>
				...
				<li><a href="${rootPath}/support/selectBoardList.do?bbsId=BBSMSTR_000000000053" id="top1m4"><img src="${imagePath}/inc/gnb/gnb04.gif" alt="업무지원" /></a>
					<div id="snbmenu_m4">
						<ul>
							<li class="snb_topBg"></li>
							<li class="snb_cenBg">
