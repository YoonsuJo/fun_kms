    	...
    	<TABLE>
			<TR>
				<TD width="800" align="center" height="500" valign="top">
					<iframe width="100%" height="100%" name="vew" id="vew" title="마이페이지 보기"  src = "<c:out value='/uss/ivp/mpe/selectIndvdlpgeResult.do'/>" frameborder="0" marginwidth="0" marginheight="0" scrolling="yes">
	    			</iframe>
				</TD>
			</TR>
			</TABLE>
