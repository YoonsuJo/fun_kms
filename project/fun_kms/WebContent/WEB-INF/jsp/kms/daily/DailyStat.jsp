					...
					<legend>상단 검색</legend>
	                    <div class="scheduleDate mB20">
	                		<ul>
		                		<li class="li_left">
		                			기간 :
		                			<input type="text" class="input01 w70 calGen" name="searchDateFrom" value="${searchVO.searchDateFrom}"/>
<!--		                			onchange="checkDateFrom();"/>-->
		                			~
		                			<input type="text" class="input01 w70 calGen" name="searchDateTo" value="${searchVO.searchDateTo}"/>
