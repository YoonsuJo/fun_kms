	...
	<div id="container">
		...
		<%@ include file="../common/menu/leftMenu.jsp"%>
			...
			<div id="center">
					...
					<legend>상단 검색</legend>
						...
						<tbody>
							<tr>
								...
								<td>
									<span class="stxt_btn">
										<a href="javascript:searchOrg();" ><img src="${imagePath}/btn/btn_dailyOrg.gif"/></a>
									</span>
								</td>
							</tr>
							<tr>
								<td class="pT5 txt_center" colspan="3">
									<c:forEach items="${memberList}" var="member" varStatus="s">
										<c:choose>
											<c:when test="${user.isLeader eq 'Y' && (user.userNo eq '2' || user.userNo eq '414')}">
												<c:if test="${member.orgId eq 'ORGAN_00000000000004' || member.orgId eq 'ORGAN_00000000000012' || member.orgId eq 'ORGAN_00000000000211' || member.orgId eq 'ORGAN_00000000000311' || member.orgId eq 'ORGAN_00000000000441' || member.orgId eq 'ORGAN_00000000000442' || member.orgId eq 'ORGAN_00000000000443' || member.orgId eq 'ORGAN_00000000000444' || member.orgId eq 'ORGAN_00000000000447' || member.orgId eq 'ORGAN_00000000000448' || member.orgId eq 'ORGAN_TOP_ORGAN_CODE'}">
				...
				<!-- 게시판 시작  -->
					<p >
						<a href="#row_0"><img src="${imagePath}/btn/btn_Sun.gif"/></a>
