		...
		<%@ include file="../common/menu/leftMenu.jsp"%>
			...
			<div id="center">
				...
				<div class="section01">
	                    ...
	                    <tbody>
	                    	...
	                    	<tr>
		                    	...
		                    	<td class=" pL10">
		                    		...
		                    		<input type="radio" class="check" name="type" value="${type.code}" onclick="javascript:changeType(this);" <c:if test="${result.type == type.code}">checked="checked"</c:if>/>
									...
									<select  name="account" class="select01" >
										<c:forEach items="${accountList}" var="account">
											<option
												...
												<c:if test="${account.codeDc != result.type}">style="display:none;"</c:if>
	                    	...
	                    	<tr>
		                    	...
		                    	<td class="pL10"><input type="text" class="input01 span_11" name="expense" id="expense" value="${result.expense }"/></td>
	                    	</tr>
	                    	<tr>
					...
					<!-- 버튼 시작 -->
           		    <div class="btn_area">
                		<img src="../../images/btn/btn_save.gif" onclick="javascript:updateFund();" class="cursorPointer"/>
