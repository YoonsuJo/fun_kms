	...
	<div id="container">
		...
		<%@ include file="../common/menu/leftMenu.jsp"%>
			...
			<div id="center">
				<div class="path_navi">
					<ul>
						<li class="stitle">세금계산서 신청내역 수정하기</li>
					...
					<div class="boardList02 mB20">
	                    ...
	                    <tbody>
	                    	...
	                    	<tr>
		                    	...
		                    	<td colspan="3" class="td_last pL10">E-mail <input type="text" class="input01 span_6"/><span class="pL10"></span> 담당자 <input type="text" class="input01 span_6"/> <span class="pL10"></span>연락처 <input type="text" class="input01 span_6"/> <input type="image" src="../../images/btn/btn_delete04.gif" class="search_btn02" /><br/>
		                    	<input type="image" src="../../images/btn/btn_add03.gif" class="search_btn02" /></td>
	                    	</tr>
	                    	<tr>
		                    	<td class="txt_center bG">발행일(*)</td>
		                    	<td colspan="3" class="td_last pL10"> <input type="text" class="input01 span_5"/></td>
	                    	</tr>  
	                    	<tr>
