...
<form name="writeFrm" action="${rootPath}/management/updatePrjInputPlan.do">
...
<input type="hidden" name="prjId" id="prjId2" value="${result.prjId}" />
	...
	<table cellpadding="0" cellspacing="0" summary="각 게시물의 상세 내용을 볼 수 있습니다.">
		...
		<tbody>
			...
			<tr>
			 	...
			 	<td class="pL10">
			 		<input type="text" name="prjNm" id="prjNm2" value="${result.prjNm}" class="input01 span_12" onfocus="prjGen('prjNm2','prjId2',1);"/>
			 		<img src="${imagePath}/btn/btn_tree.gif" onclick="prjGen('prjNm2','prjId2',1);"/>
			 	</td>
			</tr>     
			<tr>
			 	<td class="title">투입률</td>
			 	<td class="pL10"><input type="text" name="inputPercent" value="${result.inputPercent}" class="input01 span_4" /> %</td>
			</tr>     
			<tr>
			 	<td class="title">투입기간</td>
			 	<td class="pL10">
			 		<input type="text" name="inputSdt" value="${result.inputSdt}" class="input01 span_4 calGen" /> ~
			 		<input type="text" name="inputEdt" value="${result.inputEdt}" class="input01 span_4 calGen" />
			 	</td>
			</tr>                   			                    			                    	
		</tbody>
	</table>
