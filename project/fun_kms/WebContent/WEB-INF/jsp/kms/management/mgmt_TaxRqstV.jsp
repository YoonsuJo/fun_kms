		...
		<%@ include file="../common/menu/leftMenu.jsp"%>
			...
			<div id="center">
				...
				<div class="section01">
					...
					<p class="th_stitle">채권관리 정보 <input type="image" src="../../images/btn/btn_change2.gif" class="search_btn02"/></p>
           		 	<!-- 게시판 시작  -->
					<div class="boardList02 mB20">
						<table cellpadding="0" cellspacing="0" summary="각 게시물의 상세 내용을 볼 수 있습니다.">
	                    <caption>공지사항 보기</caption>
	                    ...
	                    <tbody>
	                    	<tr>
		                    	...
		                    	<input type="text" class="input01 span_17"/> <input type="image" src="../../images/btn/btn_tree.gif" class="search_btn02"/> <span class="pL20"></span>금액(원) <input type="text" class="input01 span_6" /><br/>
		                    	<input type="text" class="input01 span_17"/> <input type="image" src="../../images/btn/btn_tree.gif" class="search_btn02"/> <span class="pL20"></span>금액(원) <input type="text" class="input01 span_6" />
	                    	</tr>                			               
	                    </tbody>
	                    </table>
					</div>
					...
					<!-- 버튼 시작 -->
           		    <div class="btn_area">
                		<a href="#"><img src="../../images/btn/btn_publishComp.gif"/></a> <a href="#"><img src="../../images/btn/btn_publishCancel.gif"/></a> <a href="#"><img src="../../images/btn/btn_modify.gif"/></a> <a href="#"><img src="../../images/btn/btn_delete.gif"/></a> <a href="#"><img src="../../images/btn/btn_list.gif"/></a>
               	    </div>
                 	<!-- 버튼 끝 -->
				</div>
				<!-- E: section -->
