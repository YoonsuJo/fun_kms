...
<table border="0">
  <tr>
    <td width="700">
<!-- ********** 여기서 부터 본문 내용 *************** -->
<form name="progrmChangeRequstForm" action ="<c:url value='/sym/mpm/EgovProgramChgHstListSelect.do'/>" method="post">
<DIV id="main" style="display:"> 

<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <h1><img src="<%=imagePath_icon %>tit_icon.gif" width="16" height="16" hspace="3" alt=""/>&nbsp;프로그램변경이력상세조회</h1></td>
 </tr>
</table>
...
<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <img src="<%=imagePath_icon %>tit_icon_pop.gif" width="16" height="16" hspace="3"  alt=""/>&nbsp;변경요청내역</td>
 </tr>
</table>
...
<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <img src="<%=imagePath_icon %>tit_icon_pop.gif" width="16" height="16" hspace="3" alt="">&nbsp;변경처리내역</td>
 </tr>
</table>
