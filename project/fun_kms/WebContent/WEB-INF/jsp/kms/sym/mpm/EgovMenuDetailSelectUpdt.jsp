...
<form:form commandName="menuManageVO"  action ="/sym/mpm/EgovMenuDetailSelectUpdt.do" method="post">

<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <h1><img src="${ImgUrl}icon/tit_icon.gif" width="16" height="16" hspace="3" alt=""/>&nbsp;메뉴상세조회및 수정</h1></td>
 </tr>
</table>
<table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="메뉴상세정보" >
  ...
  <tr> 
    ...
    <td width="85%" colspan="3">
        ...
        <a href="/sym/mpm/EgovProgramListSearch.do" target="_blank" title="새창으로 이동" onclick="searchFileNm();return false;"  style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='${ImgUrl}icon/search2.gif' />"
         alt='' width="15" height="15" />(프로그램파일명 검색)</a>
    </td>
  </tr>
  <tr> 
    <th width="15%" height="23" class="required_text" scope="row"><label for="relateImageNm">관련이미지명</label><img src="${ImgUrl}icon/required.gif" width="15" height="15" alt="필수"/></th>
    <td width="35%" >&nbsp;
      <form:input path="relateImageNm" size="30" maxlength="30" title="관련이미지명"/>
      <form:errors path="relateImageNm" />
    </td>
    <th width="15%" height="23" class="required_text" scope="row"><label for="relateImagePath">관련이미지경로</label><img src="${ImgUrl}icon/required.gif" width="15" height="15" alt="필수"/></th>
    <td width="35%" >&nbsp;
...
<table width="717" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    <td height="10">
		...
		<tr> 
		  <td width="90%"></td>
          <td><span class="button"><a href="<c:url value='/sym/mpm/EgovMenuManageSelect.do'/>" onclick="selectList(); return false;">목록</a></span></td>     
          <td width="2%"></td>
