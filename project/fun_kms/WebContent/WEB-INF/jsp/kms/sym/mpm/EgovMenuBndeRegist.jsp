...
<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
   ...
   <h1><img src="<%=imagePath_icon %>/tit_icon.gif" width="16" height="16" hspace="3" alt=""/>&nbsp;메뉴일괄등록</h1></td>
   <td width="10%"></td>
   <td width="35%"></td> 
  </tr>
</table>
 ...
 <tr>
  <td width="100%"> 
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register">
      <tr> 
        <th width="20%" height="40" class="required_text">일괄파일<img src="/images/egovframework/cmm/sym/zip/icon/required.gif" width="15" height="15" alt="필수"/>&nbsp;</th>
        <td width="80%">
          <table border="0" cellspacing="0" cellpadding="0" align="left">
            <tr> 
