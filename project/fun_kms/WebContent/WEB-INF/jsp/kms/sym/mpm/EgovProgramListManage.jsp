...
<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%"class="title_left">
   <h1><img src="<%=imagePath_icon %>tit_icon.gif" width="16" height="16" hspace="3" alt="">&nbsp;프로그램목록관리</h1></td>
  <th >
  </th>
  <td width="10%" ></td>
  <td width="35%"></td> 
 ...
 <tr>
  <td width="100%"> 
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="프로그램목록관리 검색조건">
      ...
      <tr> 
        <th width="20%" height="40" class="" scope="row"><label for="searchKeyword">프로그램명</label><img src="<%=imagePath_icon %>required.gif" width="15" height="15" alt="필수"></th>
        <td width="80%">
          <table border="0" cellspacing="0" cellpadding="0" align="left">
            <tr> 
              <td >&nbsp;<input name="searchKeyword" type="text" size="60" value=""  maxlength="60" id="F1" title="검색조건"></td>
              <td width="5%"></td>
  ...
  <tr>
    ...
    <td width="25%" height="10">&nbsp;
          <table border="0" cellspacing="0" cellpadding="0" align="right">
            <tr> 
              <td width="5%"></td>
              <td><span class="button"><a href="<c:url value='/sym/mpm/EgovProgramListRegist.do'/>" onclick="insertProgramListManage(); return false;"><spring:message code="button.create" /></a></span></td>     
              <td width="5%"></td>
...
<table width="717" cellpadding="8" class="table-line" style="table-layout:fixed" summary="프로그램목록관리 목록으로 프로그램파일명, 프로그램명, url,프로그램설명 으로 구성">
 ...
 <thead>
  <tr>
    ...
    <th class="title" width="150" scope="col">주소</th>      
  </tr>
 </thead>    
 <tbody>
 <c:forEach var="result" items="${list_progrmmanage}" varStatus="status">
  <tr>
    ...
    <td class="lt_text" style="cursor:hand;" nowrap>                                 
            <span class="link"><a href="<c:url value='/sym/mpm/EgovProgramListDetailSelect.do'/>?tmp_progrmNm=<c:out value="${result.progrmFileNm}"/>"  onclick="selectUpdtProgramListDetail('<c:out value="${result.progrmFileNm}"/>'); return false;"><c:out value="${result.progrmFileNm}"/></a></span>
    </td>
    <td class="lt_text" nowrap><c:out value="${result.progrmKoreanNm}"/></td>
    <td class="lt_text" nowrap><c:out value="${result.URL}"/></td>
    <td class="lt_text" ><c:out value="${result.progrmDc}"/></td>
    <td class="lt_text" nowrap><a href='<c:out value="${result.URL}"/>' target="_blank">url+</a></td>  
  </tr>
 </c:forEach>
 </tbody>  
 <!--tfoot>
