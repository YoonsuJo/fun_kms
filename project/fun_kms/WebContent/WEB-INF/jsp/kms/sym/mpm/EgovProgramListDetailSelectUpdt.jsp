...
<form:form commandName="progrmManageVO" action="/sym/mpm/EgovProgramListDetailSelectUpdt.do">
<DIV id= "main"> 

<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <h1><img src="${ImgUrl}icon/tit_icon.gif" width="16" height="16" hspace="3" alt="">&nbsp;프로그램목록 상세조회 /수정</h1></td>
 </tr>
</table>
<table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="프로그램목록 상세조회 /수정">
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="progrmStrePath">저장경로</label><img src="${ImgUrl}icon/required.gif" width="15" height="15" alt="필수"></th>
    <td width="80%" nowrap>
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="progrmKoreanNm">한글명</label><img src="${ImgUrl}icon/required.gif" width="15" height="15" alt="필수"></th>
    <td width="80%" nowrap>
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="URL">URL</label><img src="${ImgUrl}icon/required.gif" width="15" height="15" alt="필수"></th>
    <td width="80%" nowrap>
  ...
  <tr> 
    <td>
		...
		<tr> 
          ...
          <td><span class="button"><a href="<c:url value='/sym/mpm/EgovProgramListManageSelect.do'/>" onclick="selectList(); return false;">목록</a></span></td>     
          <td width="5%"></td>
          ...
          <td width="5%"></td>
          <td><span class="button"><a href="<c:url value='/sym/mpm/EgovProgramListManageDelete.do'/>?progrmFileNm=<c:out value="${progrmManageVO.progrmFileNm  }"/>" onclick="deleteProgramListManage(document.forms[0]); return false;"><spring:message code="button.delete" /></a></span></td>  
		</tr>
		</table>
    </td>
  </tr>
