...
<table border="0">
  <tr>
    <td width="700">
<!-- ********** 여기서 부터 본문 내용 *************** -->
<form name="menuManageForm" action ="<c:url value='/sym/mpm/EgovMenuManageSelect.do'/>" method="post">
...
<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%" class="title_left">
     <h1><img src="<%=imagePath_icon %>/tit_icon.gif" width="16" height="16" hspace="3" alt=""/>&nbsp;메뉴관리리스트</h1></td>
  <td width="10%" ></td>
  <td width="35%"></td> 
  <td width="10%"></td>  
 </tr>
 ...
 <tr>
  <td width="100%"> 
	...
	<caption>메뉴관리 검색조건</caption>
      <tr> 
        <th width="20%" height="40" class="" scope="row" ><label for="searchKeyword">메뉴명</label><img src="<%=imagePath_icon %>/required.gif" width="15" height="15" alt="필수" /></th>
        <td width="80%">
  ...
  <tr>
    ...
    <td width="25%" height="10">&nbsp;
       <table border="0" cellspacing="0" cellpadding="0" summary="메뉴관리 처리버튼">
        ...
        <tr> 
             <td><span class="button"><a href="<c:url value='/sym/mpm/EgovMenuRegistInsert.do'/>" onclick="bndeInsertMenuManage(); return false;">일괄등록</a></span></td>     
             <td width="5%"></td>
             <td><span class="button"><a href="<c:url value='/sym/mpm/EgovMenuRegistInsert.do'/>" onclick="insertMenuManage(); return false;"><spring:message code="button.create" /></a></span></td>     
             <td width="5%"></td>
