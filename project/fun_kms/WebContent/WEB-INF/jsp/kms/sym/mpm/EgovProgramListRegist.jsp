...
<table border="0">
  <tr>
    <td width="700">
<!-- ********** 여기서 부터 본문 내용 *************** -->
<form:form commandName="progrmManageVO"  action="/sym/mpm/EgovProgramListRegist.do" method="post" >
<DIV id="main" style="display:"> 

<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <h1><img src="${ImgUrl}icon/tit_icon.gif" width="16" height="16" hspace="3" alt=""/>&nbsp;프로그램목록 등록</h1></td>
 </tr>
</table>
...
<tr> 
  ...
  <td><span class="button"><a href="<c:url value='/sym/mpm/EgovProgramListManageSelect.do'/>" onclick="selectList(); return false;"><spring:message code="button.list" /></a></span></td>     
  <td width="5%"></td>
