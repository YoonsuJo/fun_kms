...
<form name="searchUpperMenuIdForm" action ="<c:url value='/sym/mpm/EgovMenuListSelectTmp.do'/>" method="post">
...
<table width="570" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%"class="title_left"> 
   <h1><img src="<%=imagePath_icon %>tit_icon.gif" width="16" height="16" hspace="3" alt="">&nbsp;메뉴이동</h1></td>
  <th >
  </th>
  <td width="10%" ></td>
  <td width="35%"></td> 
