...
function fn_egov_deleteBkmkInf(){
	...
	if(confirm("삭제하시겠습니까?")){
    	...
    	document.frm.action = "<c:url value='/sym/mpm/EgovBkmkMenuManageDelete.do'/>";
    	document.frm.submit(); 
    }
}
	...
	function fn_egov_select_bkmkInfs(pageNo){
		...
		document.frm.action = "<c:url value='/sym/mpm/selectBkmkMenuManageList.do'/>";
		document.frm.submit();		
	}
	
	function fn_egov_add_bkmkInfs(){
		document.frm.action = "<c:url value='/sym/mpm/addBkmkInf.do'/>";
		document.frm.submit();	
	}
	
	function fn_egov_preview_bkmkInfs(){
		var retVal;
		var url = "<c:url value='/sym/mpm/openPopup.do?requestUrl=/sym/mpm/previewBkmkInf.do&width=850&height=360'/>";
...
<form name="frm" action = "/sym/mpm/selectBkmkMenuManageList.do" method="post">
	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="30%"class="title_left">
	   <img src="<c:url value='/images/egovframework/sym/mpm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">
	   &nbsp;바로가기 메뉴관리</td>
	  ...
	  <th width="20%">
	   <table border="0" cellspacing="0" cellpadding="0">
	    <tr> 
	    <td><span class="button"><a href="<c:url value='/sym/mpm/openPopup.do?requestUrl=/sym/mpm/previewBkmkInf.do&width=850&height=360'/>" onclick="fn_egov_preview_bkmkInfs(); return false;" title="새창 " >미리보기</a></span></td> 
	      <td>&nbsp;&nbsp;</td>
	    <td><span class="button"><a href="<c:url value= 'fn_egov_deleteBkmkInf()'/>" onclick="fn_egov_deleteBkmkInf(); return false;">삭제</a></span></td>
	     <td>&nbsp;&nbsp;</td>
	    <td><span class="button"><a href="<c:url value='/sym/mpm/addBkmkInf.do'/>" onclick="fn_egov_add_bkmkInfs(); return false;">등록</a></span></td>
	    </tr>
	   </table>
	  </th>  
	 </tr>
