...
<form:form commandName="progrmManageDtlVO"  action ="<c:url value='/sym/mpm/EgovProgramChangRequstStre.do'/>" method="post">
<div id="main" style="display:"> 

<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <h1><img src="${ImgUrl}icon/tit_icon.gif" width="16" height="16" hspace="3"  alt=""/>&nbsp;프로그램변경요청 등록</h1></td>
 </tr>
</table>
...
<table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register"   summary="프로그램변경요청 ">
  ...
  <tr> 
    <th width="145" height="23" class="required_text" scope="row"><label for="rqesterNo">요청번호</label><img src="${ImgUrl}icon/required.gif" width="15" height="15" alt="필수"/></th>
    <td width="527" nowrap>&nbsp;
  ...
  <tr> 
    <th width="145" height="23" class="required_text" scope="row"><label for="progrmFileNm">프로그램파일명</label><img src="${ImgUrl}icon/required.gif" width="15" height="15" alt="필수"/></th>
    <td width="527" nowrap>&nbsp; 
        ...
        <img src="<c:url value='${ImgUrl}icon/search2.gif' />" alt='(프로그램파일명 검색)' width="15" height="15" />(프로그램파일명 검색)</a>
    </td>
  </tr>
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="rqesterPersonId">요청자</label><img src="${ImgUrl}icon/required.gif" width="15" height="15" alt="필수"/></th>
    <td width="80%" nowrap>&nbsp;
  ...
  <tr> 
    ...
    <td width="80%" nowrap>&nbsp; 
	  ...
	  <form:input path="rqesterDe" size="50"  maxlength="50"  title="요청일자"/>  
