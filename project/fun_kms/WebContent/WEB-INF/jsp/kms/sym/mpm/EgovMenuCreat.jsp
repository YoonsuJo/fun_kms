...
<script language="javascript1.2" type="text/javaScript" src="/js/egovframework/sym/mpm/EgovMenuCreat.js"></script>
...
function fMenuCreatSiteMap() {
	...
	window.open('/sym/mpm/EgovMenuCreatSiteMapSelect.do?authorCode='+id,'Pop_SiteMap','scrollbars=yes, width=550, height=700');
}
...
<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  ...
  <h1><img src="<%=imagePath_icon %>tit_icon.gif" width="16" height="16" hspace="3" alt="">&nbsp;메뉴생성</h1></td>
  <td width="10%"></td>
  <td width="25%"></td>
  <th width="25%">
