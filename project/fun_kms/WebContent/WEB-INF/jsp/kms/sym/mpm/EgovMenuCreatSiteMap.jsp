...
<script language="javascript1.2" type="text/javaScript" src="/js/egovframework/sym/mpm/EgovMenuCreatSiteMap.js"></script>
...
<table width="490" cellpadding="8" class="table-search" border="0" align="center">
 <tr>
  ...
  <h1><img src="<%=imagePath_icon %>tit_icon.gif" width="16" height="16" hspace="3" alt=""/>&nbsp;메뉴사이트맵생성</h1></td>
  <td width="10%"></td>
  <td width="25%"></td>
  <th width="25%">
