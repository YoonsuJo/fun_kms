...
<form name="progrmChangeRequstForm" action ="<c:url value='/sym/mpm/EgovProgramChangeRequstSelect.do'/>?pageIndex=1" method="post">
<input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>"/>

<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%"class="title_left">
   <h1><img src="<%=imagePath_icon %>tit_icon.gif" width="16" height="16" hspace="3" alt="">&nbsp;프로그램변경요청</h1></td>
  <th >
  </th>
  <td width="10%" ></td>
  <td width="35%"></td> 
 ...
 <tr>
  <td width="100%"> 
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register"  summary="프로그램변경요청  조건검색">
      ...
      <tr> 
        <th width="20%" height="40" class="" scope="row" ><label for="searchKeyword">프로그램파일명</label><img src="<%=imagePath_icon %>required.gif" width="15" height="15" alt="필수"></th>
        <td width="80%">
  ...
  <tr>
    ...
    <td width="25%" height="10">&nbsp;
          <table border="0" cellspacing="0" cellpadding="0" align="right">
            <tr> 
              <td width="5%"></td>
              <td><span class="button"><a href="<c:url value='/sym/mpm/EgovProgramChangRequstStre.do'/>" onclick="insertChangeRequst(); return false;"><spring:message code="button.create" /></a></span></td>     
              <td width="10"></td>     
            </tr>
          </table>  
    </td>
...
<table width="717" cellpadding="8" class="table-line" style="table-layout:fixed" summary="프로그램변경요청  조회화면으로 요청번호,프로그램파일명,요청제목,요청자,요청일자,처리여부로 구성.">
 ...
 <c:forEach var="result" items="${list_changerequst}" varStatus="status">
  <tr>
    ...
    <td class="lt_text" style="cursor:hand;" nowrap>
      <form name="item" method="post" action="<c:url value='/sym/mpm/EgovProgramChangRequstDetailSelect.do'/>">
