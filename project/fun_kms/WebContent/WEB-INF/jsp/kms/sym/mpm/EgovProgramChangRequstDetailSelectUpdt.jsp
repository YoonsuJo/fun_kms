...
<table border="0">
  <tr>
    <td width="700">
<!-- ********** 여기서 부터 본문 내용 *************** -->
<form:form commandName="progrmManageDtlVO" action ="<c:url value='/sym/mpm/EgovProgramChangRequstDetailSelectUpdt.do'/>" method="post">
<DIV id="main" style="display:"> 

<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <h1><img src="${ImgUrl}icon/tit_icon.gif" width="16" height="16" hspace="3" alt=""/>&nbsp;프로그램변경요청 상세조회 /수정</h1></td>
 </tr>
</table>
...
<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <img src="${ImgUrl}icon/tit_icon_pop.gif" width="16" height="16" hspace="3" alt=""/>&nbsp;변경요청내역</td>
 </tr>
</table>
...
<table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register">
  ...
  <tr> 
    ...
    <td>
      &nbsp;
      <form:textarea path="rqesterProcessCn" rows="4" cols="75" title="변경처리내용"/>
...
<tr> 
      <td width="90%"></td>
  	  <td><span class="button"><a href="<c:url value='/sym/mpm/EgovProgramChangeRequstSelect.do'/>" onclick="selectList(); return false;">목록</a></span></td>     
	  <td width="2%"></td>
