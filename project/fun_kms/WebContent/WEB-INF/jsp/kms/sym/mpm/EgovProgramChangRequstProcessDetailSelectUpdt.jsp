...
<form:form commandName="progrmManageDtlVO" action ="<c:url value='/sym/mpm/EgovProgramChangRequstProcessDetailSelectUpdt.do' />" method="post">
<DIV id="main"> 

<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <h1><img src="${ImgUrl}icon/tit_icon.gif" width="16" height="16" hspace="3" alt="">&nbsp;프로그램변경요청처리상세조회/수정</h1></td>
 </tr>
</table>
...
<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <img src="${ImgUrl}icon/tit_icon_pop.gif" width="16" height="16" hspace="3" alt="">&nbsp;변경처리내역</td>
 </tr>
</table>
<table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register"  summary="변경처리내역 ">
   	<caption>변경처리내역</caption>
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="processDe">변경처리일자</label><img src="${ImgUrl}icon/required.gif" width="15" height="15" alt="필수"></th>
    <td width="80%" nowrap>&nbsp;
	  <input type="hidden" name="cal_url" value="<c:url value='/sym/cmm/EgovNormalCalPopup.do'/>" />	
	  <form:input path="processDe" size="10" cssClass="txaIpt" maxlength="10" title="변경처리일자"/>  
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="opetrId">변경처리자</label><img src="${ImgUrl}icon/required.gif" width="15" height="15" alt="필수"></th>
    <td width="80%" nowrap>
      &nbsp; 
      	<form:input path="opetrId" size="30" cssClass="txaIpt" maxlength="30" title="변경처리자"/>
		<form:errors path="opetrId" />
    </td>
  </tr>
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="processSttus">변경처리상태</label><img src="${ImgUrl}icon/required.gif" width="15" height="15" alt="필수"></th>
    <td width="80%" nowrap>&nbsp; 
...
<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <img src="${ImgUrl}icon/tit_icon_pop.gif" width="16" height="16" hspace="3" alt=""/>&nbsp;변경요청내역</label></td>
 </tr>
</table>
...
<table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="변경요청내역 ">
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="rqesterNo">요청번호</label><img src="${ImgUrl}icon/required.gif" width="15" height="15" alt="필수"/></th>
    <td width="80%" nowrap>
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="progrmFileNm">프로그램파일명</label><img src="${ImgUrl}icon/required.gif" width="15" height="15" alt="필수"/></th>
    <td width="80%" nowrap>
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="rqesterPersonId">요청자ID</label><img src="${ImgUrl}icon/required.gif" width="15" height="15" alt="필수" /></th>
    <td width="80%" nowrap>
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="rqesterDe">요청일자</label><img src="${ImgUrl}icon/required.gif" width="15" height="15" alt="필수"/></th>
    <td width="80%" nowrap>
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row"><label for="rqesterSj">요청제목</label><img src="${ImgUrl}icon/required.gif" width="15" height="15" alt="필수"/></th>
    <td width="80%" nowrap>
  ...
  <tr> 
    ...
    <td>
      &nbsp;
      <form:textarea path="changerqesterCn" rows="5" cols="75" cssClass="txaClass" title="변경요청내용"/>
...
<table width="717" border="0" cellspacing="0" cellpadding="0" align="left">
	<tr> 
	  <td width="90%"></td>
	  <td><span class="button"><a href="<c:url value='/sym/mpm/EgovProgramChangeRequstProcessListSelect.do'/>" onclick="selectList(); return false;">목록</a></span></td>     
	  <td width="5%"></td>
