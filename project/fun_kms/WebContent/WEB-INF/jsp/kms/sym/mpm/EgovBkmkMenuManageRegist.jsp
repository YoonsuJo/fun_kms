...
<link href="<c:url value='/css/egovframework/sym/mpm/com.css' />" rel="stylesheet" type="text/css">
<link href="<c:url value='/css/egovframework/sym/mpm/button.css' />" rel="stylesheet" type="text/css">
...
<script type="text/javascript">
	function fn_egov_regist_bkmkInf(){
		...
		if(confirm("등록하시겠습니까?")){
			document.bkmk.action = "<c:url value='/sym/mpm/registBkmkInf.do'/>";
	...
	function fn_egov_select_bkmkInfs(){				
		document.bkmk.action = "<c:url value='/sym/mpm/selectBkmkMenuManageList.do'/>";
		document.bkmk.submit();		
	}
	...
	function fn_egov_inqire_menu(){
		var retVal;
		var url = "<c:url value='/sym/mpm/openPopup.do?requestUrl=/sym/mpm/selectMenuList.do&width=850&height=360'/>";
		...
		if(retVal != null){
			...
			document.bkmk.action = "<c:url value='/sym/mpm/addBkmkInf.do'/>";
			document.bkmk.submit();			
		}			
	}		
...
<form  name="bkmk" method="post" action = "<c:url value='/sym/mpm/registBkmkInf.do'/>">
...
<div id="border" style="width:730px">
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="25%"class="title_left" style="width: 173px">
	   <img src="<c:url value='/images/egovframework/sym/mpm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" alt="" >&nbsp;바로가기메뉴등록</td>
	   <th>
	   </th>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register">
	  <tr> 
	    ...
	    <img src="<c:url value='/images/egovframework/sym/mpm/icon/required.gif' />" width="15" height="15" alt="required"></th>
	    <td width="80%" nowrap colspan="3">
	      ...
	      <a href="javascript:fn_egov_inqire_menu();" style="selector-dummy: expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/sym/mpm/icon/search2.gif' />"
	   ...
	   <table border="0" cellspacing="0" cellpadding="0">
	    <tr>	    
	      <td><span class="button"><input type="submit" value="저장" onclick="fn_egov_regist_bkmkInf(); return false;"></span></td>
	    	       <td>&nbsp;&nbsp;</td>
  		<td><span class="button"><a href="<c:url value='/sym/mpm/selectBkmkMenuManageList.do'/>?pageIndex=<c:out value='${searchVO.pageIndex}'/>" onclick="fn_egov_select_bkmkInfs(); return false;">목록</a></span></td> 
