...
<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%" class="title_left">
   <h1><img src="<%=imagePath_icon %>tit_icon.gif" width="16" height="16" hspace="3" alt=""/>&nbsp;메뉴생성관리</h1></td>
  <th >
  </th>
  <td width="10%" ></td>
  <td width="35%" ></td> 
  ...
  <tr> 
    ...
    <td class="lt_text3" >
       <table border="0" cellspacing="0" cellpadding="0" align="center">
         <tr> 
           <td width="10"></td>  
    	   <td><span class="button"><a href="<c:url value='/sym/mpm/EgovMenuCreatSelect.do'/>?authorCode='<c:out value="${result.authorCode}"/>'"  onclick="selectMenuCreat('<c:out value="${result.authorCode}"/>'); return false;">메뉴생성</a></span></td>
           <td width="10"></td>     
         </tr>
       </table>
    </td>
