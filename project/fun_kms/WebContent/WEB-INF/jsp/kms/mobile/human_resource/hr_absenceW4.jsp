...
function seleWsOverTm(){
	var wsHrCnt = Number(document.frm.wsOverTm.value) - 18;
	if (wsHrCnt < 0) wsHrCnt += 24;

	document.frm.wsHrCnt.value = wsHrCnt;
	document.frm.wsBgnTm.value = document.frm.wsOverTm.value;
}
...
<div class="tab2">
	<ul>
		...
		<li class="tab2_des"><a href="javascript:goInsertView('N');">야근</a></li>
	</ul>
</div>
<br /><br /><br />
...
<input type="hidden" name="wsBgnTm" />
<input type="hidden" name="wsEndTm" />
...
<tr>
	<th scope="col">근무종료<br/>시각</th>
	<td scope="col">
		<ul>
			<li style="height:25px;">당일 : 
		...
		<ul>
			<li style="">익일 : 	
				<select name="wsOverTm" onchange="seleWsOverTm();">
					<option value="">--</option>
