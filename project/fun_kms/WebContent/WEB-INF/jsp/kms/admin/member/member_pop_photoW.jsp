...
<div id="pop_file">
 	...
 	<div id="pop_file_con">
 		<form name="frm" method="POST" enctype="multipart/form-data" action="<c:url value='${rootpath}/admin/member/uploadPhoto.do' />">
		...
		<input type="hidden" name="returnUrl" value="<c:url value="${rootPath}/admin/member/popPhoto.do" />"/>
 		<ul>
 			<li>
