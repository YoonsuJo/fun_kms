...
function register() {
	...
	document.frm.action = "<c:url value='${rootPath}/admin/dining/updtDining.do'/>";
	document.frm.submit();
}
...
<body><div id="pop_dining">
	...
	<input type="hidden" name="returnUrl" value="${rootPath}/admin/dining/updtDiningView.do" /> 
 	<div id="pop_con09">
 		<table cellpadding="0" cellspacing="0">
 			...
 			<tbody>
				<tr>
					...
					<td class="subtitle2">
						<input type="text" name="dinYear" class="input_01 span_1" maxlength="4" value="${result.dinYear}" /> 년
					</td>
				</tr>
				<tr>
					<td class="subtitle">부서별 인원수 기준일자</td>
					<td class="subtitle2">
						<input type="text" name="dinDate" id="dinDate" class="input_01 span_1" onfocus="numGen('dinDate',1,31,10);" value="${result.dinDate}" /> 일
					</td>
				</tr> 	
				<tr>
					<td class="subtitle">1인당 월별 배정금액</td>
					<td class="subtitle2">
						<input type="text" name="dinMoney" class="input_01 span_5" id="dinMoney" value="<print:currency cost='${result.dinMoney}'/>" onkeydown="check(this);" onkeyup="display();" /> 원
					</td>
				</tr>
 			</tbody>
 		</table>
		...
		<div class="pop_btn_area">
			<a href="javascript:register();"><img src="${imagePath}/admin/btn/btn_modify.gif"/></a>
