...
<table cellpadding="0" cellspacing="0" summary="각 게시물의 번호,제목,작성자,등록일,첨부,조회를 볼수 있고 제목 링크를 통해서 게시물 상세 내용으로 이동합니다.">
	...
	<thead>
		...
		<th scope="col">인건비1(월)</th>
		<th scope="col">인건비2(월)</th>
		<th scope="col">인건비3(월)</th>
		<th scope="col">수정</th>
	...
	<tbody>
		<c:forEach items="${resultList2}" var="result" varStatus="status">
			<tr>
				...
				<td class="txt_center userSalary1"><print:currency cost="${result.salary1}"/></td>
				<td class="txt_center userSalary2"><print:currency cost="${result.salary2}"/></td>
				<td class="txt_center userSalary3"><print:currency cost="${result.salary3}"/></td>
