 	...
 	<div id="pop_con08">
            	...
            	<tbody>
           			<tr>
			            ...
			            <td class="title">상태</td>
				           <td class="pL10">
					            <c:choose>
									<c:when test="${resultList[0].workSt=='W'}">근무</c:when>
									<c:when test="${resultList[0].workSt=='L'}">휴직</c:when>
									<c:when test="${resultList[0].workSt=='R'}">퇴직</c:when>
 		...
 		<table cellpadding="0" cellspacing="0">
 			...
 			<thead>
 				<tr>
 					<th class="th_left" ></th>
 					<th class="th_center" colspan="6">${resultList[0].year}년도 월별 인건비</th>
				...
				<tr>
					<td colspan="8">
						<c:forEach items="${resultList}" var="elem" begin="0" end="5" varStatus="status">
							<ul>
								<li><input type="text" name="salaryList" value="<print:currency cost='${elem.salary1}'/>"/></li>
								<li><input type="text" name="salaryList" value="<print:currency cost='${elem.salary2}'/>"/></li>
								<li><input type="text" name="salaryList" value="<print:currency cost='${elem.salary3}'/>""/></li>
							</ul>
						</c:forEach>
					</td>
				</tr>
