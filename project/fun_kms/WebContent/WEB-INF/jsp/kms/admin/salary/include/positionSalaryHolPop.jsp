...
<form id="positionSalaryForm" name="positionSalaryForm">
<div id="pop_expense">
 	<div id="pop_top">
 	   <ul>
			<li><img src="${imagePath}/admin/inc/pop_bullet.gif" /></li>
			<li class="popTitle">보직별 기준인건비 등록</li>
		</ul>
 	</div>
 	...
 	<div id="pop_con07">
 		<div class="expense_stxt">
            ...
            <colgroup><col class="col10" /><col class="col10" /><col class="col10" /><col class="col10" /><col class="col10" /><col class="col10" /></colgroup>
            	<tbody>
           			<tr>
						<td class="title">보직코드</td>
		          	  	<td class="pL10">${resultList[0].positionCode }</td>
			            <td class="title">보직명</td>
			            <td class="pL10">${resultList[0].positionNm }</td>
 		...
 		<table cellpadding="0" cellspacing="0">
 			...
 			<thead>
 				<tr>
 					<th class="th_left" ></th>
 					<th class="th_center" colspan="6">2011년도 월별 기준인건비</th>
