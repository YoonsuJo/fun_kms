...
function excelDown1() {
	...
	document.frm1.action = "/admin/statistics/selectExpenseExcel1.do";
...
function excelDown2() {
	...
	document.frm2.action = "/admin/statistics/selectExpenseExcel2.do";
		...
		<%@ include file="../left.jsp"%>
			...
			<div id="center_bg">
				...
				<div id="center">
					...
					<!-- S: section -->
					<div class="section01">	
						<p class="th_stitle">경비지출내역 엑셀 출력</p>
					...
					<!-- S: section -->
					<div class="section01">	
						<p class="th_stitle">법인카드지출내역 엑셀 출력</p>
