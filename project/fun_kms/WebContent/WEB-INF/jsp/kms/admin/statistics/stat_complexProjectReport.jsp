...
function excelDown1() {
	...
	if(form.find('[name=startDt]').val() == null || form.find('[name=startDt]').val().length<8 ||
		...
		alert("시작월/종료월을 입력하여 주십시오.");
		return; 
	}
	document.frm1.action = "/admin/statistics/selectComplexProjectReportExcel1.do";
...
function excelDown2() {
	...
	document.frm2.action = "/admin/statistics/selectComplexProjectReportExcel2.do";
		...
		<%@ include file="../left.jsp"%>
			...
			<div id="center_bg">
				...
				<div id="center">
					<div class="path_navi">
						<ul>
							<li class="stitle">개인별 프로젝트투입율 및 프로젝트 실적</li>
						</ul>
					</div>
	
					<!-- S: section -->
					<div class="section01">	
						<p class="th_stitle">개인별 프로젝트투입율 및 프로젝트 실적 엑셀 출력</p>
					...
					<!-- S: section -->
					<div class="section01" style="display:none" >	
						<p class="th_stitle">회사별 개인별 프로젝트투입율 및 프로젝트 실적 엑셀 출력</p>
