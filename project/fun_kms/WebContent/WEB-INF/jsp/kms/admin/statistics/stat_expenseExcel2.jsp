...
<table border="0" cellpadding="0" cellspacing="0">
	...
	<thead>
		<tr>
			<th colspan="13">법인카드 지출내역 (기간 : ${startDt} ~ ${endDt})</th>
		</tr>
		<tr>
			...
			<th style="background-color:#dbdbdb;border-top:2px solid #666666;border-bottom:1px solid #666666;">승인번호</th>
			<th style="background-color:#dbdbdb;border-top:2px solid #666666;border-bottom:1px solid #666666;">가맹점명</th>
			<th style="background-color:#dbdbdb;border-top:2px solid #666666;border-bottom:1px solid #666666;">업종</th>
	...
	<tbody>
		<c:forEach items="${resultList}" var="result">
			<tr>
				...
				<td class="txt_center">${result.cardAppNo}</td>
				<td class="txt_center">${result.cardStoreNm}</td>
				<td class="txt_center">${result.cardStoreTyp}</td>
