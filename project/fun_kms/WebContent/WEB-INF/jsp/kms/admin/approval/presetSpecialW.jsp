...
<validator:javascript formName="adminSpecialPreset" staticJavascript="false" xhtml="true" cdata="false"/>
<script>
$(document).ready(function(){
	var form = $('#presetVO');
	var mode ="${mode}";
	$('#presetSaveB').click(function(){
		if(!validateAdminSpecialPreset(document.presetVO))
			return;		
		if(mode=="W")
						...
						<div class="boardWrite02 mB20">
		                    ...
		                    <tbody>
 								<tr>
									...
									<td class="pL10" >
										<form:input path="prjFnm" cssClass="span_22" readonly="true" onfocus="prjGen('prjFnm','prjId',1);"/>
