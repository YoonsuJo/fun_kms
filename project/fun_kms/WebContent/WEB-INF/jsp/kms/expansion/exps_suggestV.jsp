...
<c:import url="${rootPath}/expansion/selectCommentList.do" charEncoding="utf-8">
...
function modifyArticle() {
	document.frm.action = "<c:url value='${rootPath}/expansion/forUpdateBoardArticle.do'/>";
	document.frm.submit();		
}
function deleteArticle() {
	if (confirm('<spring:message code="common.delete.msg" />')) {
		document.frm.action = "<c:url value='${rootPath}/expansion/deleteBoardArticle.do'/>";
		document.frm.submit();
	}	
}
...
function listArticle() {
	...
	document.frm.action = "<c:url value='${rootPath}/expansion/selectUnreadBoardList.do'/>";
	</c:if>
	document.frm.submit();
}
function insertHistory(state) {
	document.stFrm.sgstSt.value = state;
	document.stFrm.action = "<c:url value='${rootPath}/expansion/insertSuggestHistory.do'/>";
			...
			<div id="center_bg">
				...
				<div id="center">
					...
					<div class="section01">
						...
						<p class="th_stitle">${bdMstr.bbsNm} <span class="th_count">(조회수 ${result.inqireCo})</span></p>
						...
						<form name="stFrm" method="POST">
							...
							<c:import url="${rootPath}/expansion/selectSuggestHistory.do" charEncoding="utf-8">
							</c:import>
						</form>
					</div>
					<!-- E: section -->
