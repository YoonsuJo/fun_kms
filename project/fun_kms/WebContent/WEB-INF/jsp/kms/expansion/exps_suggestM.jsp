...
function update() {
	...
	document.board.action = "<c:url value='${rootPath}/expansion/updateBoardArticle.do'/>";
			...
			<div id="center_bg">
				...
				<div id="center">
					...
					<div class="section01">
						...
						<input type="hidden" name="returnUrl" value="<c:url value='${rootPath}/expansion/forUpdateBoardArticle.do'/>"/>
