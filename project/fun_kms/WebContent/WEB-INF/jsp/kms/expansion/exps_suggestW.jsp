...
function register() {
	...
	document.board.action = "<c:url value='${rootPath}/expansion/insertBoardArticle.do'/>";
	<c:if test="${isReply == 'Y'}">
	document.board.action = "<c:url value='${rootPath}/expansion/replyBoardArticle.do'/>";
	</c:if>
	document.board.submit();					
}
function listArticle() {
	document.board.action = "<c:url value='${rootPath}/expansion/selectBoardList.do'/>";
	document.board.submit();
}
</script>
</head>
