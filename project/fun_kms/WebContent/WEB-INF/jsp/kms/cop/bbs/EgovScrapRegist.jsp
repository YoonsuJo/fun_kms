...
<script type="text/javascript">
	function fn_egov_regist_scrap() {
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {
			document.scrap.action = "<c:url value='/cop/bbs/insertScrap.do'/>";
...
<form:form commandName="scrap" name="scrap" method="post" action="${pageContext.request.contextPath}/cop/bbs/insertScrap.do">
