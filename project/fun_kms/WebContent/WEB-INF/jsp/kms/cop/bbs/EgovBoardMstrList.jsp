	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="40%" class="title_left">
	   <h1><img src="<c:url value='/images/egovframework/cop/bbs/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="">&nbsp;게시판 정보</h1>
	  </td>
		<td width="*" >
		 ...
		 <c:forEach var="result" items="${resultList}" varStatus="status">
		  <tr>
		    ...
		    <td class="lt_text3" nowrap>
			    ...
			    <!-- 2010.11.1 
c			    <form name="item" method="post" action="<c:url value='/cop/bbs/SelectBBSMasterInf.do'/>">
				...
				<a href="<c:url value='/cop/bbs/SelectBBSMasterInf.do'/>?bbsId=<c:out value='${result.bbsId}'/>"; onclick="event(this.href); return false;">
