...
<script type="text/javascript">
	...
	function fn_egov_inqire_scrap(scrapId) {
		...
		document.frm.action = "<c:url value='/cop/bbs/selectScrap.do'/>";
		document.frm.submit();			
	}
</script>
...
<div id="border" style="width:730px">
	...
	<form name="frm" method="post" action="<c:url value='/cop/bbs/selectScrapList.do'/>">
	...
	<tbody>
	 <tr>
	  <td width="40%" class="title_left">
	   <img src="<c:url value='/images/egovframework/cop/bbs/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;스크랩</td>
		<td width="10%" >
	 ...
	 <tbody>
		 <c:forEach var="result" items="${resultList}" varStatus="status">
		  <tr>
		    ...
		    <form name="item" method="post" action="<c:url value='/cop/bbs/selectScrap.do'/>">
		    	<input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>">
