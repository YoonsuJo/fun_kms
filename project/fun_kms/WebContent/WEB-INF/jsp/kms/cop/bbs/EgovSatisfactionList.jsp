...
function fn_egov_insert_satisfactionList() {
	...
	if (confirm('<spring:message code="common.regist.msg" />')) {
		document.frm.action = "<c:url value='/cop/bbs${prefix}/insertSatisfaction.do'/>";
		document.frm.submit();
	}				
}
...
function fn_egov_updt_satisfactionList() {
	...
	if (confirm('<spring:message code="common.update.msg" />')) {
		...
		document.frm.action = "<c:url value='/cop/bbs${prefix}/updateSatisfaction.do'/>";
		document.frm.submit();
	}
}
...
function fn_egov_deleteSatisfactionList(satisfactionNo, index) {
	...
	if (confirm('<spring:message code="common.delete.msg" />')) {
		document.frm.modified.value = "true";
		document.frm.stsfdgNo.value = satisfactionNo;
		document.frm.action = "<c:url value='/cop/bbs${prefix}/deleteSatisfaction.do'/>";
		document.frm.submit();
	}
}
...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left">
   <img src="<c:url value='/images/egovframework/cop/bbs/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">
...
<table width="100%" cellpadding="8" class="listTable">
	<tbody>
		<c:forEach var="result" items="${resultList}" varStatus="status">
		    ...
		    <c:if test="${anonymous == 'true'}">
		    <br>
		    	패스워드 : <input name="testPassword" type="password" size="20" value="" maxlength="20" >
		    </c:if>
		    </td>      
		  </tr> 		 
 		</c:forEach>  	
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="generalTable">
	<tr> 
	    ...
	    <td width="80%" nowrap>
	      <input name="wrterNm" type="text" size="20" value='<c:out value="${searchVO.wrterNm}" />' maxlength="20">
	      <br>
	...
	<tr> 
		<th height="23">내용</th>
	    <td>
	      <textarea name="stsfdgCn" class="textarea"  cols="50" rows="2"  style="width:100%;"><c:out value="${searchVO.stsfdgCn}" /></textarea> 
	  ...
	  <c:if test="${anonymous == 'true'}">
		  <tr> 
		    ...
		    <img src="<c:url value='/images/egovframework/cop/bbs/icon/required.gif' />" width="15" height="15" alt="required"></th>
		    <td colspan="3">
		      <input name="stsfdgPassword" type="password" size="20" value="" maxlength="20" >
		    </td>
		  </tr>	  	
	  	</c:if>
	</table>
	...
	<c:choose>
		<c:when test="${searchVO.stsfdgNo == ''}">
	      ...
	      <td style="background-image:URL(<c:url value='/images/egovframework/cop/bbs/btn/bu2_bg.gif'/>);" class="text_left" nowrap>
