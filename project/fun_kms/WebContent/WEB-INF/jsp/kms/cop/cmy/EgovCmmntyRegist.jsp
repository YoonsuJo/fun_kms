...
<c:set var="ImgUrl" value="/images/egovframework/cop/cmy/"/>
...
<div id="border" style="width:730px">
	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="100%"class="title_left">
	  	<h1>		
	  		<img src="<c:url value='/images/egovframework/cop/cmy/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="">&nbsp;커뮤니티 생성
	  	</h1>
	  </td>
	 </tr>
	</table>
	<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register"  summary="커뮤니티명, 커뮤니티 소개, 템플릿 정보, 커뮤니티 관리자 입니다" >
	  <tr> 
	    <th scope="col" width="20%" height="23" class="required_text" nowrap >
	    	...
	    	<img src="<c:url value='/images/egovframework/cop/cmy/icon/required.gif' />" width="15" height="15" alt="required">
	    </th>
	  ...
	  <tr> 
	    ...
	    <td width="30%" nowrap colspan="3">
	     ...
	     &nbsp;<a href="#LINK" onClick="javascript:javascript:fn_egov_inqire_user()" style="selector-dummy: expression(this.hideFocus=false);">
	     		<img src="<c:url value='/images/egovframework/cop/bbs/icon/search.gif' />" width="15" height="15" align="middle" alt="새창"></a>
	...
	<tr> 
		...
		<td>&nbsp;</td>  
		<td> 
			<span class="button"><input type="submit" value="<spring:message code="button.create" />" onclick="javascript:fn_egov_regist_cmmnty(); return false;"></span>
		</td>
	</tr>
	</table>
	</div>
