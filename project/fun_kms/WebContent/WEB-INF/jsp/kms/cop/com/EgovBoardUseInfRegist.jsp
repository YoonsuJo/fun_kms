...
<link href="<c:url value='/css/egovframework/cop/button.css' />" rel="stylesheet" type="text/css">
	...
	<table width="100%" cellpadding="8" class="table-search" border="0"  summary="게시판명, 커뮤니티 동호회 정보  입니다">
	 <tr>
	  <td width="100%"class="title_left">
	  	<h1>	
	  		<img src="<c:url value='/images/egovframework/cop/com/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="">&nbsp;게시판 사용등록
	  	</h1>
	  </td>
	 </tr>
	</table>
	<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register">
	  <tr>	 
	    ...
	    <td width="70%" nowrap colspan="3">
	      ...
	      &nbsp;<a href="#LINK" onclick="fn_egov_inqire_bbsInf();" style="selector-dummy: expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/cop/com/icon/search.gif' />"
