	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="100%"class="title_left">
	  	<h1>		
	  		<img src="<c:url value='/images/egovframework/cop/clb/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="">&nbsp;동호회 생성
	  	</h1>
	  </td>
	 </tr>
	</table>
	<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="소속 커뮤니티 정보,동호회 명,동호회 소개,템플릿 정보,동호회 운영자 입니다">
	  <tr> 
	    <th scope="col" width="20%" height="23" class="required_text" nowrap ><label for="cmmntyNm">소속 커뮤니티 정보
	    	<img src="<c:url value='/images/egovframework/cop/clb/icon/required.gif' />" width="15" height="15" alt="required"></label>
	    </th>
	    <td width="30%" nowrap colspan="3">
	     ...
	     &nbsp;<a href="#LINK" onclick="javascript:fn_egov_inqire_cmmnty()" style="selector-dummy: expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/cop/bbs/icon/search.gif' />"
	  ...
	  <tr> 
	    ...
	    <img src="<c:url value='/images/egovframework/cop/clb/icon/required.gif' />" width="15" height="15" alt="required"></label></th>
	  ...
	  <tr> 
	    ...
	    <td width="30%" nowrap colspan="3">
	     ...
	     &nbsp;<a href="#LINK" onclick="javascript:fn_egov_inqire_tmplat()"style="selector-dummy: expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/cop/bbs/icon/search.gif' />"
	     			width="15" height="15" align="middle" alt="search"></a>
	  ...
	  <tr> 
	    ...
	    <td width="30%" nowrap colspan="3">
	     ...
	     &nbsp;<a href="#LINK" onclick="javascript:fn_egov_inqire_cmmntyUser()" style="selector-dummy: expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/cop/bbs/icon/search.gif' />"
	     			width="15" height="15" align="middle" alt="search"></a>
