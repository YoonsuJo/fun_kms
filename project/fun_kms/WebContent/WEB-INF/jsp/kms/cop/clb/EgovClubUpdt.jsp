	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="100%"class="title_left">
	  	<h1>		
	  		<img src="<c:url value='/images/egovframework/cop/clb/icon/tit_icon.gif' />" width="16" height="16" hspace="3" alt="">&nbsp;동호회 정보수정
	  	</h1>
	  </td>
	 </tr>
	</table>
	<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register"  summary="소속 커뮤니티 정보, 동호회 명, 동호회 소개, 게시판 정보, 템플릿 정보, 동호회 운영자, 사용여부, 생성자, 생성일시   입니다" >
	  ...
	  <tr> 
	    ...
	    <input name="emplyrNm" type="text" size="20" id = "emplyrNm" value='<c:out value="${clubUser.emplyrNm}" />' maxlength="20" readonly >
	     &nbsp;<a href="#LINK" onclick="javascript:fn_egov_inqire_cmmntyUser('<c:out value="${clubVO.clbId}" />');" style="selector-dummy: expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/cop/bbs/icon/search.gif' />"
	     			width="15" height="15" align="middle" alt="search"></a>
