...
function linkPage(pageNo){
	...
	document.listForm.action = "/ems/selectSndngMailList.do";
 ...
 ******************************************************** */
function fnRegist(){
	document.listForm.action = "/ems/insertSndngMailView.do";
   	document.listForm.submit();
}
/* ********************************************************
 * 상세회면 처리 함수
...
function fnDetail(mid){
	document.detailForm.action = "/ems/selectSndngMailDetail.action";
...
function fnDelete(){
    ...
    if(checkedIds.length > 0) {
    	...
    	if (ret == true) {
    		...
    		document.deleteForm.action = "/ems/deleteSndngMailList.do";
		...
		<form name="listForm" action="<c:url value='/ems/selectSndngMailList.do'/>" method="post">
			...
			<table width="700" cellpadding="8" class="table-search" border="0">
			  <tr>
			    ...
			    <img src="/images/egovframework/ems/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;발송내역 조회</h1></td>
			    <th></th>
			    <td width="100">
			    ...
			    <th width="150">
			      <table border="0" cellspacing="0" cellpadding="0">
			        <tr> 
				      ...
				      <td style="background-image:URL(<c:url value='/images/egovframework/ems/bu2_bg.gif'/>);" class="text_left" nowrap><a href="#noscript" onclick="fnDelete(); return false;">삭제</a> 
				      </td>
			...
			<tbody>
			  ...
			  <tr style="cursor:hand;">
			    <td class="lt_text3" nowrap>
                  <input type="checkbox" name="checkField" class="check2" title="선택" id="checkField">
                  <input name="checkId" type="hidden" value="<c:out value='${resultInfo.mssageId}'/>" title="" id="checkId"/>
                  <input name="checkFileId" type="hidden" value="<c:out value='${resultInfo.atchFileId}'/>" title="" id="checkFileId"/>
                </td>
			    ...
			    <td class="lt_text6" nowrap><a href="/ems/selectSndngMailDetail.action" onclick="fnDetail('${resultInfo.mssageId}'); return false;">${resultInfo.sj}</a></td>
