...
function update() {
	...
	if (document.board.orgnztIdId.value == "") {
		alert("프로젝트를 선택해주세요.");
		return;
	}
	document.board.action = "<c:url value='${rootPath}/cooperation/updateOrgBoard.do'/>";
			...
			<div id="center_bg">
				...
				<div id="center">
					...
					<div class="section01">
						...
						<p class="th_stitle">프로젝트게시판</p>
						<!-- 게시판 시작  -->
						<form:form commandName="commBoard" name="board" method="post" enctype="multipart/form-data" >
						<input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>"/>
						<input type="hidden" name="returnUrl" value="<c:url value='${rootPath}/community/updateOrgBoardView.do'/>"/>
						...
						<div class="boardWrite">
		                    ...
		                    <thead>
		                        ...
		                        <tr>
			                    	...
			                    	<th class="write_info2">
			                    		<input type="text" class="write_input" name="orgnztNm" id="orgnztNm" value="${result.orgnztNm}" readonly="readonly" onclick="prjGen('orgnztNm','orgnztId',1);"/>
										<img src="${imagePath}/btn/btn_tree.gif" onclick="orgGen('orgnztNm','orgnztId',1);" class="cursorPointer"/>
			                    		<input type="hidden" class="write_input" name="orgnztId" id="orgnztId" value="${result.orgnztId}"/>
			                    	</th>
		                        </tr>
		                        <tr>
