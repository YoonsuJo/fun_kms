...
function update() {
	...
	if (document.board.prjId.value == "") {
		alert("프로젝트를 선택해주세요.");
		return;
	}
	document.board.action = "<c:url value='${rootPath}/cooperation/updatePrjBoard.do'/>";
...
function listArticle() {
	document.board.action = "<c:url value='${rootPath}/cooperation/selectPrjBoardList.do?prjId=${searchVO.prjId}'/>";
	document.board.submit();
}
</script>
</head>
			...
			<div id="center_bg">
				...
				<div id="center">
					...
					<div class="section01">
						...
						<input type="hidden" name="returnUrl" value="<c:url value='${rootPath}/community/updatePrjBoardView.do'/>"/>
						...
						<div class="boardWrite">
		                    ...
		                    <thead>
		                        ...
		                        <tr>
			                    	...
			                    	<th class="write_info2">
			                    		<input type="text" class="write_input" name="prjNm" id="prjNm" value="${result.prjNm}" readonly="readonly" onclick="prjGen('prjNm','prjId',1);"/>
										<img src="${imagePath}/btn/btn_tree.gif" onclick="prjGen('prjNm','prjId',1);" class="cursorPointer"/>
			                    		<input type="hidden" class="write_input" name="prjId" id="prjId" value="${result.prjId}"/>
			                    	</th>
		                        </tr>
		                        <tr>
