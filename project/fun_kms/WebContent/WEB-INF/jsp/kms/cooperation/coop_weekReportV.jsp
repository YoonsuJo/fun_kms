...
function modifyArticle() {
	document.frm.action = "<c:url value='${rootPath}/cooperation/updateWeekReportView.do'/>";
	document.frm.submit();		
}
function deleteArticle() {
	if (confirm('<spring:message code="common.delete.msg" />')) {
		document.frm.action = "<c:url value='${rootPath}/cooperation/deleteWeekReport.do'/>";
		document.frm.submit();
	}	
}
function listArticle() {
	document.frm.action = "<c:url value='${rootPath}/cooperation/selectWeekReportList.do'/>";
	document.frm.submit();
}
</script>
</head>
							...
							<table cellpadding="0" cellspacing="0" summary="각 게시물의 상세 내용을 볼 수 있습니다.">
								...
								<thead>
									<tr>
										...
										<th colspan="3" class="write_info2"><c:out value="${result.nttSj}" /></th>
									</tr>
									<tr>
										<th class="write_info">소속</th>
										<th class="write_info2"><print:org orgnztId="${result.ntcrOrgnztId}" orgnztNm="${result.ntcrOrgnztNm}" /></th>
										<th class="write_info">보고부서</th>
										<th class="write_info2"><print:org orgnztNm="${result.orgnztNm}" orgnztId="${result.orgnztId}" /></th>
									</tr>
									<tr>
									...
									<tr>
										...
										<th colspan="3" class="write_info2"><print:date date="${result.exDt}"/></th>
									</tr>
								</thead>
								...
								<tfoot>
									<tr>
										...
										<td colspan="3" class="write_info2">
