...
function modifyArticle() {
	document.frm.action = "<c:url value='${rootPath}/cooperation/updateOrgBoardView.do'/>";
	document.frm.submit();		
}
function deleteArticle() {
	if (confirm('<spring:message code="common.delete.msg" />')) {
		document.frm.action = "<c:url value='${rootPath}/cooperation/deleteOrgBoard.do'/>";
		document.frm.submit();
	}	
}
function listArticle() {
	document.frm.action = "<c:url value='${rootPath}/cooperation/selectOrgBoardList.do'/>";
	document.frm.submit();
}
</script>
</head>
			...
			<div id="center_bg">
				...
				<!-- S: section -->
					<div class="section01">
						...
						<input type="hidden" name="orgnztId" value="<c:out value='${result.orgnztId}'/>" >
						...
						<div class="boardView">
		                    ...
		                    <thead>
		                        ...
		                        <tr>
			                    	...
			                    	<th class="write_info2"><print:project prjCd="${result.prjCd}" orgnztId="${result.orgnztId}" prjNm="${result.prjNm}"/></th>
