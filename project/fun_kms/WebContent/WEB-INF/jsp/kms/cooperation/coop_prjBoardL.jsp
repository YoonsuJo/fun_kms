...
function write() {
	document.frm.action = "${rootPath}/cooperation/insertPrjBoardView.do";
	document.frm.submit();
}
function selRadio(n) {
	...
	<div id="container">
		...
		<%@ include file="../common/menu/leftMenu.jsp"%>
			...
			<div id="center_bg">
				...
				<!-- S: section -->
				<div class="section01">
					<p class="th_stitle mT10 mB10">${searchVO.searchPrjNm}</p>

			    	<form name="frm" id="frm" method="POST" action="${rootPath}/cooperation/selectPrjBoardList.do" onsubmit="search(1); return false;">
					...
					<legend>상단 검색</legend>
						...
						<tbody>
							<tr>
								<td>
									<label><input type="checkbox" name="includeUnderPrj" value="Y" <c:if test="${searchVO.includeUnderPrj == 'Y'}">checked="checked"</c:if>> 하위프로젝트 포함</label><span class="pL30"></span>
								</td>
				...
				<form name="subForm" method="post" action="${rootPath}/cooperation/selectPrjBoard.do">
