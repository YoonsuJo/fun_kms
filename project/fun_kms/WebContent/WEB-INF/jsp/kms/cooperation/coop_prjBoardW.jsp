...
function register() {
	...
	document.board.action = "<c:url value='${rootPath}/cooperation/insertPrjBoard.do'/>";
		                    ...
		                    <thead>
		                    	<tr>
			                        ...
			                        <th class="write_info2">
			                        	<input type="text" class="write_input" name="nttSj" />
		                        ...
		                        <tr>
			                    	...
			                    	<th class="write_info2">
			                    		<input type="text" class="write_input" name="prjNm" id="prjNm" readonly="readonly" onclick="prjGen('prjNm','prjId',1);" value="${searchVO.searchPrjNm}"/>
										<img src="${imagePath}/btn/btn_tree.gif" onclick="prjGen('prjNm','prjId',1);" class="cursorPointer"/>
			                    		<input type="hidden" class="write_input" name="prjId" id="prjId" value="${searchVO.prjId}"/>
			                    	</th>
		                        </tr>
		                        <tr>
