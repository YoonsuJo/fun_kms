...
function listArticle() {
	location.href = '${rootPath}/cooperation/selectCustomerList.do';
}
						...
						<div class="boardWrite02 mB20">
							...
							<tbody>
								...
								<tr>
									...
									<td class="pL10">
										<input type="text" name="custTelno" class="span_9" maxlength="20" />
									</td>
									<td class="title">FAX</td>
									<td class="pL10">
										<input type="text" name="custFaxno" class="span_9" maxlength="20" />
									</td>
								</tr>
								<tr>
