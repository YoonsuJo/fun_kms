...
<!-- content start -->
        ...
        <table width="717" cellpadding="8" class="table-search" border="0">
            ...
            <img src="/images/egovframework/cmm/uss/umt/icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle" alt=""/>&nbsp;기업회원 등록</td>
            </tr>
        </table>
        <table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register">
            <tr> 
                ...
                <td width="80%" nowrap><label for="entrprsmberId"/>
                    <form:input path="entrprsmberId" id="entrprsmberId" size="20" cssClass="txaIpt" readonly="true" maxlength="20"  onclick="javascript:fnIdCheck();" />
                    <a href="#LINK" onclick="fnIdCheck()">
                        <img src="/images/egovframework/cmm/uss/umt/icon/search.gif" alt=""/>
                    (중복아이디 검색)</a>
            ...
            <tr> 
                ...
                <td width="80%" nowrap><label for="areaNo"/>
                    <form:input path="areaNo" id="areaNo" cssClass="txaIpt" size="5" maxlength="20" />
