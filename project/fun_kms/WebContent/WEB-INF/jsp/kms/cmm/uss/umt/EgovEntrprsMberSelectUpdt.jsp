...
<body>
        ...
        <table width="717" cellpadding="8" class="table-search" border="0">
            ...
            <img src="/images/egovframework/cmm/uss/umt/icon/tit_icon.gif" width="16" height="16" hspace="3" alt=""/>&nbsp;기업회원 상세조회(수정)</td>
            </tr>
        </table>
        <table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register">
            <tr> 
                ...
                <td width="80%" nowrap><label for="entrprsmberId"/>
                    <form:input path="entrprsmberId" id="entrprsmberId" size="20" cssClass="txaIpt" readonly="true" maxlength="20" />
            ...
            <tr> 
                <th width="20%" height="23" class="required_text" nowrap >
                    회사명<img src="/images/egovframework/cmm/uss/umt/icon/required.gif" width="15" height="15" alt=""/>
                </th>
                <td width="80%" nowrap><label for="cmpnyNm"/>
                    ...
                    <form:input path="cmpnyNm" id="cmpnyNm" size="45" cssClass="txaIpt" readonly="false" maxlength="50" />
            ...
            <tr> 
                ...
                <td width="80%" nowrap><label for="entrprsMberPasswordCnsr"/>
                    <form:input path="entrprsMberPasswordCnsr" id="entrprsMberPasswordCnsr" cssClass="txaIpt" size="50" maxlength="100" />
            ...
            <tr> 
                ...
                <td width="80%" nowrap><label for="cxfc"/>
                    <form:input path="cxfc" id="cxfc" cssClass="txaIpt" size="20"  maxlength="8" />
                    <div><form:errors path="cxfc" cssClass="error"/></div>
                </td>
            </tr>
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
                    사업자등록번호<img src="/images/egovframework/cmm/uss/umt/icon/required.gif" width="15" height="15" alt=""/>
                </th>
                <td width="80%" nowrap><label for="bizrno"/>
                    <form:input path="bizrno" id="bizrno" cssClass="txaIpt" size="20" maxlength="20" />
            ...
            <tr> 
                ...
                <td width="80%" nowrap><label for="jurirno"/>
                    <form:input path="jurirno" id="jurirno" cssClass="txaIpt" size="20" maxlength="13" />
                    <div><form:errors path="jurirno" cssClass="error"/></div>
                </td>
            </tr>
            <tr> 
                <th width="20%" height="23" class="required_text" nowrap >
                    회사전화번호<img src="/images/egovframework/cmm/uss/umt/icon/required.gif" width="15" height="15" alt=""/>
                </th>
                <td width="80%" nowrap>
                    <label for="areaNo"/><form:input path="areaNo" id="areaNo" cssClass="txaIpt" size="5" maxlength="20" />
                    - <label for="entrprsMiddleTelno"/><form:input path="entrprsMiddleTelno" id="entrprsMiddleTelno" cssClass="txaIpt" size="5" maxlength="100" />
                    - <label for="entrprsEndTelno"/><form:input path="entrprsEndTelno" id="entrprsEndTelno" cssClass="txaIpt" size="5" maxlength="5" />
            ...
            <tr> 
                ...
                <td width="80%" nowrap><label for="adres"/>
                    <form:input path="adres" id="adres" cssClass="txaIpt" size="70" maxlength="50" readonly="true" />
            ...
            <tr> 
                ...
                <td width="80%" nowrap><label for="detailAdres"/>
                    <form:input path="detailAdres" id="detailAdres" cssClass="txaIpt" size="70"  maxlength="50" />
                    <div><form:errors path="detailAdres" cssClass="error"/></div>
                </td>
            </tr>
            <tr> 
                <th width="20%" height="23" class="required_text" nowrap >
                    신청자이름<img src="/images/egovframework/cmm/uss/umt/icon/required.gif" width="15" height="15" alt=""/>
                </th>
                <td width="80%" nowrap><label for="applcntNm"/>
                    <form:input path="applcntNm" id="applcntNm" cssClass="txaIpt" size="20" maxlength="20" />
                    <div><form:errors path="applcntNm" cssClass="error"/></div>
                </td>
            </tr>
            <tr> 
                <th width="20%" height="23" class="required_text" nowrap >
                    신청자이메일주소<img src="/images/egovframework/cmm/uss/umt/icon/required.gif" width="15" height="15" alt=""/>
                </th>
                <td width="80%" nowrap><label for="applcntEmailAdres"/>
                    <form:input path="applcntEmailAdres" id="applcntEmailAdres" cssClass="txaIpt" size="20" maxlength="20" />
            ...
            <tr> 
                <th width="20%" height="23" class="required_text" nowrap >
                    기업회원상태코드<img src="/images/egovframework/cmm/uss/umt/icon/required.gif" width="15" height="15" alt=""/>
                </th>
            ...
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="0" align="center">
		            <tr>
                        ...
                        <!-- 삭제 -->
                        <td><span class="button"><a href="<c:url value='/uss/umt/entrprs/EgovEntrprsMberDelete.do'/>" onclick="fnDeleteEntrprs('<c:out value='${entrprsManageVO.userTy}'/>:<c:out value='${entrprsManageVO.uniqId}'/>');; return false;"><spring:message code="button.delete" /></a></span>&nbsp;</td>
                        <!-- 목록 -->
                        ...
                        <!-- 암호변경 -->
                        <td><span class="button"><a href="<c:url value='/uss/umt/entrprs/EgovEntrprsPasswordUpdtView.do'/>" onclick="fnPasswordMove();"><spring:message code="button.passwordUpdate" /></a></span>&nbsp;</td>
                        <!-- 취소 -->
