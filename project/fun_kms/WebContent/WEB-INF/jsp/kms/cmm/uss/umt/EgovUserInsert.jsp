...
<link href="<c:url value='/css/egovframework/cmm/uss/umt/com.css' />" rel="stylesheet" type="text/css"/>
...
<!-- content start -->
        ...
        <table width="717" cellpadding="8" class="table-search" border="0">
            <tr>
              <td width="100%" class="title_left"><img src="/images/egovframework/cmm/uss/umt/icon/tit_icon.gif" width="16" height="16" hspace="3" alt="" />&nbsp;업무사용자 등록</td>
            </tr>
        </table>
        <table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register">
            <tr> 
                <th width="20%" height="23" class="required_text">사용자아이디<img src="/images/egovframework/cmm/uss/umt/icon/required.gif" width="15" height="15" alt="" /></th>
                <td width="80%" >
                    <form:input path="emplyrId" id="emplyrId" title="사용자아이디" cssClass="txaIpt" size="20" maxlength="20" readonly="true" />
                    <a href="#LINK" onclick="fnIdCheck();">
                        <img src="/images/egovframework/cmm/uss/umt/icon/search.gif" alt=""/>(중복아이디 검색)
                    </a>
            ...
            <tr> 
                ...
                <td width="80%" >
                    <form:input path="ofcpsNm" id="ofcpsNm" title="직위명" cssClass="txaIpt" size="20" maxlength="50" />
            ...
            <tr> 
                ...
                <td width="80%" >
                    <form:input path="emplNo" id="emplNo" title="사번" cssClass="txaIpt" size="20" maxlength="20" />
            ...
            <tr> 
                ...
                <td width="80%" >
                    <form:input path="brth" id="brth" cssClass="txaIpt" title="생일" size="20" maxlength="8" />
                    <div><form:errors path="brth" cssClass="error" /></div>
                </td>
            </tr>
            <tr> 
                <th width="20%" height="23" class="required_text"  >
                    집전화지역번호<img src="/images/egovframework/cmm/uss/umt/icon/required.gif" width="15" height="15" alt=""/>
                </th>
                <td width="80%" >
            ...
            <tr> 
                ...
                <td width="80%" >
                    <form:input path="subDn" id="subDn" cssClass="txaIpt" title="사용자DN" size="40" maxlength="100" />
