...
<body>
        <table width="717" cellpadding="8" class="table-search" border="0">
            ...
            <img src="/images/egovframework/cmm/uss/umt/icon/tit_icon.gif" width="16" height="16" hspace="3" alt="" />&nbsp;기업회원관리</td>
            </tr>
        </table>
        <!-- content start -->
        <form name="listForm" action="<c:url value='/uss/umt/entrprs/EgovEntrprsMberManage.do'/>" method="post">
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <!-- 목록 -->
                <td><span class="button"><a href="<c:url value='/uss/umt/entrprs/EgovEntrprsMberManage.do'/>" onclick="fnSearch(); return false;"><spring:message code="button.list" /></a></span>&nbsp;</td>
                <!-- 등록 -->
                <td><span class="button"><a href="<c:url value='/uss/umt/entrprs/EgovEntrprsMberInsertView.do'/>" onclick="fnAddUserView(); return false;"><spring:message code="button.create" /></a></span>&nbsp;</td>
            </tr>
        </table>
        <br/>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="lt_text3" style="cursor:pointer;cursor:hand" >
						<span class="link"><a href="<c:url value='/uss/umt/entrprs/EgovEntrprsMberSelectUpdtView.do'/>?selectedId=<c:out value="${result.uniqId}"/>"  onclick="javascript:fnSelectUser('<c:out value="${result.userTy}"/>:<c:out value="${result.uniqId}"/>'); return false;"><c:out value="${result.userId}"/></a></span>
					</td>
