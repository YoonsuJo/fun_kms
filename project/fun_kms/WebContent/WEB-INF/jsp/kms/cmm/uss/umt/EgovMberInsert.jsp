...
<body>
        ...
        <table width="717" cellpadding="8" class="table-search" border="0">
            <tr>
                <td width="100%" class="title_left"><img src="/images/egovframework/cmm/uss/umt/icon/tit_icon.gif" width="16" height="16" hspace="3" alt="" />&nbsp;일반회원 등록</td>
            </tr>
        </table>
        <table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register">
            <tr> 
                ...
                <td width="80%" >
                    <form:input path="mberId" id="mberId" title="일반회원아이디" size="20" cssClass="txaIpt" readonly="true" maxlength="20" />
            ...
            <tr> 
                ...
                <table border="0" cellspacing="0" cellpadding="0" align="center">
		            <tr> 
                        ...
                        <!-- 목록 -->
                        <td><span class="button"><a href="<c:url value='/uss/umt/mber/EgovMberManage.do'/>" onclick="fnListPage(); return false;"><spring:message code="button.list" /></a></span>&nbsp;</td>
                        <!-- 취소 -->
