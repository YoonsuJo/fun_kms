...
<body>
        <table width="717" cellpadding="8" class="table-search" border="0" summary="타이틀 기능을 제공한다.">
            <tr>
              <td width="100%" class="title_left"><img src="/images/egovframework/cmm/uss/umt/icon/tit_icon.gif" width="16" height="16" hspace="3" alt=""/>&nbsp;사용자관리</td>
            </tr>
        </table>
        <!-- content start -->
                ...
                <td>
                    <table border="0" cellspacing="0" cellpadding="0" summary="">
                      <tr>
                        ...
                        <td><span class="button"><a href="<c:url value='/uss/umt/user/EgovUserManage.do'/>"><spring:message code="button.list" /></a></span>&nbsp;</td>
                        <td><span class="button"><a href="<c:url value='/uss/umt/user/EgovUserInsertView.do'/>" onclick="fnAddUserView(); return false;"><spring:message code="button.create" /></a></span>&nbsp;</td>
                      </tr>
                    </table>
                </td>
            </tr>
