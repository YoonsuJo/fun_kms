...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="90%" class="title_left">
   <img src="<c:url value='/images/egovframework/uss/umt/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="">&nbsp;부서 수정
  </td>
 </tr>
</table>
...
<table width="100%" cellpadding="8" class="table-line">
  <tr>
    <th class="required_text" width="20%" nowrap>부서ID<img src="/images/egovframework/uss/umt/icon/required.gif" width="15" height="15" alt=""></th>
  ...
  <tr>
    <th class="required_text" width="20%" nowrap>부서명<img src="/images/egovframework/uss/umt/icon/required.gif" width="15" height="15" alt=""></th>
  ...
  <tr>
    <th class="required_text" width="20%" nowrap>설명<img src="/images/egovframework/uss/umt/icon/no_required.gif" width="15" height="15" alt=""></th>
