...
<body>
        ...
        <table width="717" cellpadding="8" class="table-search" border="0">
            <tr>
                <td width="100%" class="title_left"><img src="/images/egovframework/cmm/uss/umt/icon/tit_icon.gif" width="16" height="16" hspace="3" alt=""/>&nbsp;일반회원관리</td>
            </tr>
        </table>
        <!-- content start -->
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <!-- 목록 -->
                <td><span class="button"><a href="<c:url value='/uss/umt/mber/EgovMberManage.do'/>" onclick="fnSearch(); return false;"><spring:message code="button.list" /></a></span>&nbsp;</td>
                <!-- 등록 -->
                <td><span class="button"><a href="<c:url value='/uss/umt/mber/EgovMberInsertView.do'/>" onclick="fnAddUserView(); return false;"><spring:message code="button.create" /></a></span>&nbsp;</td>
            </tr>
        </table>
        <br/>
