...
<img src="/images/egovframework/main_top02.jpg" alt="egovframe" />
      ...
      <td width="350" height="250">
          ...
          <form name="loginForm" action ="<c:url value='/uat/uia/actionLogin.do'/>" method="post">
            ...
            <table width="303" border="0" cellspacing="8" cellpadding="0">
              <tr>
                <td width="40%"class="title_left"><img src="/images/egovframework/cmm/uat/uia/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle" alt="login">&nbsp;일반로그인</td>
              </tr>
              <tr>
                <td width="303" height="210" valign="top" style="background:url(/images/egovframework/cmm/uat/uia/login_bg01.gif) no-repeat;">
...
<!-- bottom -->
    <div id="new_footer_login">
    	<ul>
        	<li><img src="/images/egovframework/botttom_logo.gif" alt="행정안정부" /></li>
    		<li class="gap"><img src="/images/egovframework/botttom_address.gif" alt="32" /> </li>
    	</ul>
    </div>
