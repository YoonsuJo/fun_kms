...
function fncLoginPolicyInsert() {
    ...
    var varFrom = document.getElementById("loginPolicy");
    varFrom.action = "<c:url value='/com/uat/uia/addLoginPolicy.do'/>";
...
<table border="0">
  <tr>
    <td width="700">
<form:form commandName="loginPolicy" method="post" action="${pageContext.request.contextPath}/com/uat/uia/addLoginPolicy.do"> 
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%" class="title_left">
   <h1><img alt="" src="<c:url value='/images/egovframework/cmm/uat/uia/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle">&nbsp;로그인정책 등록</h1>
  </td>
 </tr>
</table>
...
<table width="100%" cellpadding="8" class="table-line" summary="로그인정책을 등록한다.">
  ...
  <tr>
    <th class="required_text" width="20%" scope="row" nowrap>사용자ID<img alt="" src="/images/egovframework/cmm/uat/uia/icon/required.gif" width="15" height="15"></th>
  ...
  <tr>
    <th class="required_text" width="20%" scope="row" nowrap>사용자명<img alt="" src="/images/egovframework/cmm/uat/uia/icon/required.gif" width="15" height="15"></th>
  ...
  <tr>
    <th class="required_text" width="20%" scope="row" nowrap>IP정보<img alt="" src="/images/egovframework/cmm/uat/uia/icon/required.gif" width="15" height="15"></th>
    <td class="lt_text" nowrap><input name="ipInfo" id="ipInfo" title="IP정보" type="text" maxLength="23" size="30"  >&nbsp;<form:errors path="ipInfo" /></td>
  </tr>
  <tr>
    <th class="required_text" width="20%" scope="row" nowrap>IP제한여부<img alt="" src="/images/egovframework/cmm/uat/uia/icon/required.gif" width="15" height="15"></th>
