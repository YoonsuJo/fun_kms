...
<link href="<c:url value='/css/egovframework/cmm/uat/uia/com.css' />" rel="stylesheet" type="text/css">
<link href="<c:url value='/css/egovframework/cmm/uat/uia/button.css' />" rel="stylesheet" type="text/css">
...
function fncSelectLoginPolicyList() {
    ...
    varFrom.action = "<c:url value='/com/uat/uia/selectLoginPolicyList.do'/>";
    varFrom.submit();       
}

function fncLoginPolicyUpdate() {
    var varFrom = document.getElementById("loginPolicy");
    varFrom.action = "<c:url value='/com/uat/uia/updtLoginPolicy.do'/>";
...
function fncLoginPolicyDelete() {
    var varFrom = document.getElementById("loginPolicy");
    varFrom.action = "<c:url value='/com/uat/uia/removeLoginPolicy.do'/>";
...
<table border="0">
  <tr>
    <td width="700">
<form:form commandName="loginPolicy" method="post" action="${pageContext.request.contextPath}/com/uat/uia/updtLoginPolicy.do">  
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%" class="title_left">
   <h1><img src="<c:url value='/images/egovframework/cmm/uat/uia/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="">&nbsp;로그인정책 수정</h1>
  </td>
 </tr>
</table>
...
<table width="100%" cellpadding="8" class="table-line" summary="로그인정책을 수정한다.">
  ...
  <tr>
    <th class="required_text" width="20%" scope="row" nowrap>사용자ID<img src="/images/egovframework/cmm/uat/uia/icon/required.gif" width="15" height="15" alt=""></th>
  ...
  <tr>
    <th class="required_text" width="20%" scope="row" nowrap>사용자명<img src="/images/egovframework/cmm/uat/uia/icon/required.gif" width="15" height="15" alt=""></th>
  ...
  <tr>
    <th class="required_text" width="20%" scope="row" nowrap>IP정보<img src="/images/egovframework/cmm/uat/uia/icon/required.gif" width="15" height="15" alt=""></th>
  ...
  <tr>
    <th class="required_text" width="20%" scope="row" nowrap>IP제한여부<img src="/images/egovframework/cmm/uat/uia/icon/required.gif" width="15" height="15" alt=""></th>
  ...
  <tr>
    <th class="required_text" width="20%" scope="row" nowrap>등록일시<img src="/images/egovframework/cmm/uat/uia/icon/required.gif" width="15" height="15" alt=""></th>
  ...
  <tr>
   ...
   <table border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td>&nbsp;&nbsp;</td>
      <td><span class="button"><a href="<c:url value='/com/uat/uia/removeLoginPolicy.do'/>?emplyrId=<c:out value='${loginPolicyVO.emplyrId}'/>" onclick="fncLoginPolicyDelete(); return false;"><spring:message code="button.delete" /></a></span></td>
      <td>&nbsp;&nbsp;</td>      
      <td><span class="button"><a href="<c:url value='/com/uat/uia/selectLoginPolicyList.do'/>?pageIndex=<c:out value='${loginPolicyVO.pageIndex}'/>&amp;searchKeyword=<c:out value="${loginPolicyVO.searchKeyword}"/>&amp;searchCondition=1" onclick="fncSelectLoginPolicyList(); return false;"><spring:message code="button.list" /></a></span></td>
    </tr>
   </table>  
   </td>
  </tr>  
