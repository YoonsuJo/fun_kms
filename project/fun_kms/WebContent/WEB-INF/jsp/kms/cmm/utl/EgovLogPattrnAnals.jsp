...
<div class="title_left" style="width:100%;margin:0 0 0 0;">
	<h1><img src="/images/egovframework/cmm/uss/umt/icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align:middle; display:inline-block;" alt=" ">&nbsp;로그패턴분석</h1>
</div>
...
<tr> 
	<th scope="row" width="25%" height="23" class="required_text" nowrap><label id="IdUnityLinkNm">찾을로그(패턴)명</label><img src="/images/egovframework/cmm/uss/umt/icon/required.gif" alt="필수입력" title="필수입력" width="15" height="15"></th>
	<td width="75%">
	<input type="text" title="찾을로그(패턴)명" size="10" value="<%=sTxtLogPattrn %>" name="txtLogPattrn" style="width:98%">
	</td>
</tr>
<tr> 
	<th scope="row" height="23" class="required_text" ><label id="IdUnityLinkSeCode">로그파일경로명(서버)</label><img src="/images/egovframework/cmm/uss/umt/icon/required.gif" alt="필수입력" title="필수입력" width="15" height="15"></th>
	<td>
	<input type="text" title="로그파일경로명" size="10" value="<%=sTxtLogPattrnPath %>" name="txtLogPattrnPath" style="width:98%">
	</td>
</tr> 
<tr> 
	<th scope="row" height="23" class="required_text" ><label id="IdIncodeType">인코딩형식</label><img src="/images/egovframework/cmm/uss/umt/icon/required.gif" alt="필수입력" title="필수입력" width="15" height="15"></th>
	<td>
...
<tr>       
  <th scope="row">&nbsp;</th>
  <td><img src="/images/egovframework/cmm/uss/umt/button/bu2_left.gif" alt="버튼이미지" title="버튼이미지" width="8" height="20"></td>
  ...
  <td><img src="/images/egovframework/cmm/uss/umt/button/bu2_right.gif" alt="버튼이미지" title="버튼이미지" width="8" height="20"></td>
