...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left"><h1 class="title_left">
   <img src="/images/egovframework/uss/olp/mgt/icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목">&nbsp;행정코드 수정</h1></td>
 </tr>
</table>
<!-- 줄간격조정  -->
...
<CAPTION style="display: none;">행정코드 수정</CAPTION>
  <tr> 
    <th scope="row" width="20%" height="23" class="required_text" nowrap >행정구역구분<img src="/images/egovframework/cmm/sym/ccm/icon/required.gif" alt="필수"  width="15" height="15"></th>
    <td>
  ...
  <tr>
    <th scope="row" width="20%" height="23" class="required_text" nowrap >행정구역코드<img src="/images/egovframework/cmm/sym/ccm/icon/required.gif" alt="필수"  width="15" height="15"></th>          
    <td>${administCode.administZoneCode}</td>    
  </tr> 
  <tr>
    <th scope="row" width="20%" height="23" class="required_text" nowrap >행정구역명<img src="/images/egovframework/cmm/sym/ccm/icon/required.gif" alt="필수"  width="15" height="15"></th>          
    <td width="80%" nowrap>
  ...
  <tr>
    <th scope="row" width="20%" height="23" class="required_text" nowrap >생성일자<img src="/images/egovframework/cmm/sym/ccm/icon/required.gif" alt="필수"  width="15" height="15"></th>          
    <td width="80%" nowrap>
      <input name="vcreatDe" size="10" maxlength="10" readonly onClick="javascript:fn_egov_NormalCalendar(document.administCode, document.administCode.creatDe, document.administCode.vcreatDe);" title="생성일자(새창)"/>
		<a href="#noscript" onclick="fn_egov_NormalCalendar(document.administCode, document.administCode.creatDe, document.administCode.vcreatDe); return false;" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/cmm/sym/cal/bu_icon_carlendar.gif' />" alt="달력(새창)"></a>
      <form:hidden path="creatDe"/>
      <form:errors path="creatDe"/>
    </td>    
  </tr> 
  <tr>
    <th scope="row" width="20%" height="23" class="text" nowrap >폐기일자</th>          
    <td width="80%" nowrap>
      <input  name="vablDe" size="10" maxlength="10" readonly onClick="javascript:fn_egov_NormalCalendar(document.administCode, document.administCode.ablDe, document.administCode.vablDe);" title="폐기일자(새창)"/>
		<a href="#noscript" onclick="fn_egov_NormalCalendar(document.administCode, document.administCode.ablDe, document.administCode.vablDe); return false;" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/cmm/sym/cal/bu_icon_carlendar.gif' />" alt="달력(새창)"></a>
      <form:hidden path="ablDe"/> 
      <form:errors path="ablDe"/>
    </td>    
  </tr> 
  <tr>
    <th scope="row" width="20%" height="23" class="text" nowrap >상위행정구역코드</th>          
    <td width="80%" nowrap>
      <input  name="upperAdministZoneNm" size="60" maxlength="60" value="${administCode.upperAdministZoneNm}" readonly onClick="javascript:fn_egov_AdministCodePopup(administCode.upperAdministZoneCode,administCode.upperAdministZoneNm)" title="상위행정구역코드"/>
		<a href="#noscript" onclick="fn_egov_AdministCodePopup(administCode.upperAdministZoneCode,administCode.upperAdministZoneNm); return false;" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/cmm/sym/ccm/icon/search2.gif' />" alt="행정코드찾기"></a>
      <form:hidden  path="upperAdministZoneCode"/>
      <form:errors path="upperAdministZoneCode"/>
    </td>    
  </tr> 
  <tr> 
    <th scope="row" width="20%" height="23" class="required_text" nowrap >사용여부<img src="/images/egovframework/cmm/sym/ccm/icon/required.gif" alt="필수"  width="15" height="15"></th>
...
<tr> 
  ...
  <td style="background-image:URL(<c:url value='/images/egovframework/cop/bbs/btn/bu2_bg.gif'/>);" class="text_left" nowrap><a href="#noscript" onclick="fn_egov_list_AdministCode(); return false;">목록</a></td>
