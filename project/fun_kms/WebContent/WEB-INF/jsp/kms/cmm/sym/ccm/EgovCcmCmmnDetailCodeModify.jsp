...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left"><h1 class="title_left">
   <img src="/images/egovframework/uss/olp/mgt/icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목">&nbsp;공통상세코드 수정</h1></td>
 </tr>
</table>
<!-- 줄간격조정  -->
...
<CAPTION style="display: none;">공통상세코드 수정</CAPTION>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row" nowrap >코드ID<img src="/images/egovframework/uss/olp/mgt/icon/required.gif" alt="필수"  width="15" height="15"></th>          
    <td width="80%" nowrap colspan="3">
     	${cmmnDetailCode.codeIdNm}
    </td>
  </tr> 
  <tr> 
    <th width="20%" height="23" class="required_text" scope="row" nowrap >코드<img src="/images/egovframework/uss/olp/mgt/icon/required.gif" alt="필수"  width="15" height="15"></th>
    <td width="80%" nowrap><c:out value='${cmmnDetailCode.code}'/></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" scope="row" nowrap ><label for="codeNm">코드명</label><img src="/images/egovframework/uss/olp/mgt/icon/required.gif" alt="필수"  width="15" height="15"></th>          
    <td width="80%" nowrap>
