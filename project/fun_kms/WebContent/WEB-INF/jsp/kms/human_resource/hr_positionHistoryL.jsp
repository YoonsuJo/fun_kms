			...
			<div id="center_bg">
				...
				<div id="center">
					...
					<div class="section01">
						...
						<!-- 게시판 시작 -->
						<p class="th_stitle">개인별 인사발령 상세이력 - <print:user userNo="${memberResult.member.no}" userNm="${memberResult.member.userNm}" userId="${memberResult.member.userId}" printId="true"/></p>
						<div class="boardList">
							...
							<tbody>
								<c:forEach items="${resultList}" var="result">
									<tr>
										<td class="txt_center"><c:out value="${result.chngDtPrint}" /></td>
										<td class="txt_center"><c:out value="${result.chngCodePrint}" />&nbsp;</td>
										<td class="txt_center"><c:out value="${result.aftRankNm}" />&nbsp;</td>
										<td class="txt_center"><c:out value="${result.aftCompNm}" />&nbsp;</td>
										<td class="txt_center"><c:out value="${result.aftOrgnztNm}" />&nbsp;</td>
										<td class="txt_center"><c:out value="${result.aftPositionPrint}" />&nbsp;</td>
										<td class="txt_center"><c:out value="${result.note}" escapeXml="false"/>&nbsp;</td>
									</tr>
								</c:forEach>
							</tbody>
							</table>
