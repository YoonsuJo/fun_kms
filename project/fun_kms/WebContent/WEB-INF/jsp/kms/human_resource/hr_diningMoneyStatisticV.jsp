	...
	<div id="container">
		...
		<%@ include file="../common/menu/leftMenu.jsp"%>
			...
			<div id="center">
				<div class="path_navi">
					<ul>
						<li class="stitle">팀장경비 사용 상세내역</li>
				...
				<div class="section01">
					...
					<div class="boardList02 mB20">
	                    ...
	                    <tbody>
	                    	<tr>
		                    	...
		                    	<td class="txt_center">${result.dineMoneyUsePrint}</td>
		                    	<td class="txt_center">${result.dineMoneyLeftPrint}</td>
		                    	<td class="td_last txt_center">${result.dineMoneyExpectLeftPrint}</td>
	                    	</tr>
	                    </tbody>
	                    </table>
	                </div>
					...
					<c:import url="${rootPath}/member/diningMoneyDetailList.do">
