	...
	<div id="container">
		...
		<%@ include file="../common/menu/leftMenu.jsp"%>
			...
			<div id="center">
				<div class="path_navi">
					<ul>
						<li class="stitle">자기개발비 사용 상세내역</li>
				...
				<div class="section01">
					...
					<div class="boardList02 mB20">
	                    ...
	                    <tbody>
	                    	<tr>
		                    	...
		                    	<td class="txt_center">${result.selfDev}</td>
		                    	<td class="txt_center">${result.usedPrint}</td>
		                    	<td class="txt_center">${result.fullLeft}</td>
		                    	<td class="td_last txt_center">${result.halfLeft}</td>
	                    	</tr>
	                    </tbody>
	                    </table>
	                </div>
					...
					<c:import url="${rootPath}/member/selectSelfDevDetail.do">
						<c:param name="param_searchYear" value="${searchVO.searchYear}"/>
						<c:param name="param_userNo" value="${result.userNo}"/>
					</c:import>
