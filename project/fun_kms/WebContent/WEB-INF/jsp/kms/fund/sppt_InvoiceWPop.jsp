...
function addProject(){
	var project = $('<div id="projectList['+ projectIdx + ']"><input type="text" class="span_27 input01" name="projectVOList['
			...
			+ projectIdx + '].price" id="prjprice' + projectIdx + '"/><span class="pL20"/> <input type="text" class="input02 span_6 " readonly="readonly" name="projectVOList['
			+ projectIdx + '].vat"   id="prjvat' + projectIdx + '" /><span class="pL20"/> <input type="text" class="input02 span_6 prjSum" name="projectVOList['
			+ projectIdx + '].sum" id="prjsum' + projectIdx + '" /><span class="pL20"/> <input type="text" class="input02 span_6 currency" readonly="readonly" name="projectVOList['
			+ projectIdx + '].collect" id="prjcollect' + projectIdx + '" value="0"/><span class="pL20"/><img src="../../images/btn/btn_delete04.gif" '
...
<div id="pop_reg_div01">
 	...
 	<div class="pop_reg_div02">
				...
				<form name="invoiceFm" id="invoiceFm" method="POST" action="" onsubmit="invoiceListSearch(); return false;">
					...
					<!-- 세금계산서 발행 정보 시작  -->
					<span class="fr">(*) 표시가 있는 항목은 필수 입력 항목입니다.</span>
					<p class="th_stitle">세금 계산서 발행요청 정보</p>
					<div class="pop_board mT20">
						...
						<tbody>
							<tr>
								...
								<td class="pL10" colspan="3"><input type="text" class="input01 span_95p" name="title" id="title" value=""/></td>
							...
							<tr>
								...
								<td class="pL10" colspan="3"><input type="text" class="input01 span_95p custNmAuto" name="custCompanyName" value=""/>
								...
								<td class="pL10" ><input type="text" class="input01 span_95p" name="custName1"/></td>
								<td class="pL10" ><input type="text" class="input01 span_95p" name="custEmail1"/></td>
								<td class="pL10" ><input type="text" class="input01 span_95p" name="custTelNo1"/></td>
							</tr>
							<tr>
								<td class="title">대 표 자</td>
								<td class="pL10" colspan="3"><input type="text" class="input01 span_95p" name="custCeoName" value=""/></td>
								<td class="pL10" ><input type="text" class="input01 span_95p" name="custName2"/></td>
								<td class="pL10" ><input type="text" class="input01 span_95p" name="custEmail2"/></td>
								<td class="pL10" ><input type="text" class="input01 span_95p" name="custTelNo2"/></td>
							</tr>
								<td class="title">사업자번호</td>
								<td class="pL10" colspan="3"><input type="text" class="input01 span_95p" name="custBusiNo" /></td>
								<td class="pL10" ><input type="text" class="input01 span_95p" name="custName3" /></td>
								<td class="pL10" ><input type="text" class="input01 span_95p" name="custEmail3"/></td>
								<td class="pL10" ><input type="text" class="input01 span_95p" name="custTelNo3"/></td>
							</tr>
							<tr>
								<td class="title">주    소</td>
								<td class="pL10" colspan="3"><input type="text" class="input01 span_95p" name="custAddress" /></td>
								<td class="pL10" ><input type="text" class="input01 span_95p" name="custName4"  /></td>
								<td class="pL10" ><input type="text" class="input01 span_95p" name="custEmail4" /></td>
								<td class="pL10" ><input type="text" class="input01 span_95p" name="custTelNo4" /></td>
							</tr>
							<tr>
								<td class="title">업    태</td>
								<td class="pL10" ><input type="text" class="input01 span_95p" name="custBusiType" /></td>
								<td class="title">업    종</td>
								<td class="pL10" ><input type="text" class="input01 span_95p" name="custBusiKind" /></td>
								<td class="pL10" ><input type="text" class="input01 span_95p" name="custName5"  /></td>
								<td class="pL10" ><input type="text" class="input01 span_95p" name="custEmail5" /></td>
								<td class="pL10" ><input type="text" class="input01 span_95p" name="custTelNo5" /></td>
							</tr>
							<tr >
							...
							<tr >
								<td class="pL10" colspan="7" id = "Contents">
									<div id="contentsList[0]">
										<span class="pL2"></span>
										<input type="text" class="span_10 input01" name="contentsVOList[0].productName" id="productName0" />
										<span class="pL5"></span>
										<input type="text" class="span_5 input02 price" name="contentsVOList[0].price" id="price0" />
										<span class="pL5"></span>
										<input type="text" class="span_5 input02 currency" name="contentsVOList[0].vat" id="vat0" readonly="readonly"/>
										<span class="pL5"></span>
										<input type="text" class="span_5 input02 sum" name="contentsVOList[0].sum" id="sum0" "/>
										<span class="pL5"></span>
										<input type="text" class="span_11 input01" name="contentsVOList[0].note" id="note0" />
							...
							<tr>
								...
								<td class="pL10" ><input type="text" class="input02 span_95p currency" readonly="readonly" name="totalPrice" id="totalPrice" /></td>
								<td class="pL10" ><input type="text" class="input02 span_95p currency" readonly="readonly" name="totalVat" id="totalVat" /></td>
								<td class="pL10" ><input type="text" class="input02 span_95p currency" readonly="readonly" name="totalSum" id="totalSum" /></td>
							...
							<tr>
								...
								<td class="pL10" colspan="7"> * 첨부파일을 수정하시려면 기존첨부파일을 다운로드받아 재첨부하셔야 합니다.
									<c:import url="${rootPath}/selectFileInfs.do" charEncoding="utf-8"><c:param name="param_atchFileId" />
									</c:import>
								</td>
							</tr>
							<tr>
					...
					<div class="pop_board mT20">
						...
						<tbody>
							...
							<tr>
								...
								<td class="pL10">
									<div id="repeatDiv">
										<input type="text" class="input03 w100 calGen"  readonly="readonly" name="publishReqDate" id="publishReqDate" />&nbsp;
								...
								<td class="pL10" ><input type="text" class="input03 w100 calGen" readonly="readonly" name="collectExpectDate" id="collectExpectDate" /></td>
								<td class="pL10" ><textarea class="w98%" name="comment" ></textarea></td>
							</tr>
						</tbody>
						</table>
					</div>
							...
							<tr>
								<td id="Projects" class="pL10" colspan="6">
									<div id="projectList[0]">
										<input type="text" class="span_27 input01" name="projectVOList[0].prjName" id="prjName0" readonly="readonly" onclick="prjGen('prjName0','prjId0',1);" />
										<input type="hidden" name="projectVOList[0].prjId" id="prjId0" />
										<img src="${imagePath}/btn/btn_tree.gif" onclick="prjGen('prjName0', 'prjId0', 1);" class="cursorPointer"><span class="pL20"></span> 
										<input type="text" class="input02 span_6 currency" readonly="readonly" name="projectVOList[0].price" id="prjprice0" /><span class="pL20"/>
										<input type="text" class="input02 span_6 " readonly="readonly" name="projectVOList[0].vat" id="prjvat0" /><span class="pL20"/>
										<input type="text" class="input02 span_6 prjSum" readonly="readonly" name="projectVOList[0].sum" id="prjsum0" /><span class="pL20"/>
										<input type="text" class="input02 span_6 " readonly="readonly" name="projectVOList[0].collect" id="prjcollect0" value="0" /><span class="pL20"/>
										<img src="../../images/btn/btn_add03.gif" class="cursorPointer" onclick="javascript:addProject();"/>
									</div>
								</td>
							</tr>
							<tr>
