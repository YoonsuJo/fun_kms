...
*/	
	...
	document.invoiceVOFm.action = '<c:url value="/fund/invoiceUpdate.do" />';
			...
			<div id="center">
				...
				<form:form commandName="invoiceVOFm" id="invoiceVOFm" name="invoiceVOFm" method="post" enctype="multipart/form-data" >
					...
					<div class="boardWrite02 mB20">
						...
						<tbody>
							...
							<tr >
								...
								<td class="title2">품    목</td>
								<td class="title2">공급액</td>
								<td class="title2">부가세</td>
								<td class="title2">합    계</td>
								<td class="title2" colspan="3">비       고</td>
							</tr>
							<tr >
					...
					<div class="boardWrite02 mB20">
						...
						<tbody>
							...
							<tr>
								...
								<td class="pL10">
									<div id="repeatDiv">
										<input type="text" class="input03 span_4 calGen"  readonly="readonly" name="publishReqDate" id="publishReqDate" value="${invoiceVO.publishReqDate}"/>&nbsp;
										<input type="checkbox" class="check" name="repeat" id="repeat" value="Y" disabled="true"/> 반복발행
										<div id="repeatDateDiv" style="display:none;">
											<input type="text" class="input03 span_4 calGen" readonly="readonly" name="publishToDate" id="publishToDate"/>&nbsp;까지 매월 
											<input type="text" class="span_1" name="publishAtDate" onfocus="numGen(this,1,31,7);" value="1" />일 <br/>(※ 해당일이 없는 달은 말일에 발행)
										</div>
									</div>
								</td>
								<td class="pL10" ><input type="text" class="input03 span_4 calGen" readonly="readonly" name="collectExpectDate" id="collectExpectDate" value="${invoiceVO.collectExpectDate}"/></td>
								<td class="pL10" ><textarea class="span_22" name="comment" >${invoiceVO.comment}</textarea></td>
							</tr>
						</tbody>
						</table>
					</div>
										...
										<c:choose>
											<c:when test="${c.index == 0}">
												...
												<input type="text" class="input02 span_6 " readonly="readonly" name="projectVOList[${c.index}].collect" id="prjcollect${c.index}" 
														value="<print:currency cost='${project.collect}' />" /><span class="pL30"/><img src="../../images/btn/btn_add03.gif" class="cursorPointer" onclick="javascript:addProject();"/>
											</c:when>
											<c:otherwise>
												<input type="text" class="input02 span_6 currency" readonly="readonly" name="projectVOList[${c.index}].price" id="prjprice${c.index}" 
														value="<print:currency cost='${project.price}' />" /><span class="pL30"/>
												...
												<input type="text" class="input02 span_6 prjSum" name="projectVOList[${c.index}].sum" id="prjsum${c.index}" 
														value="<print:currency cost='${project.sum}' />" /><span class="pL30"/>
												<input type="text" class="input02 span_6 " readonly="readonly" name="projectVOList[${c.index}].collect" id="prjcollect${c.index}" 
														value="<print:currency cost='${project.collect}' />" /><span class="pL30"/><img src="../../images/btn/btn_delete04.gif" 
					...
					<div class="btn_area">
						...
						<a href="javascript:history.go(-1)">[수성취소]</a> 

						<img src="../../images/btn/btn_list.gif" onclick="invoiceSearch();" class="cursorPointer"/>
					</div>  <!-- btn_area -->
