	...
	<div id="container">
		...
		<%@ include file="../common/menu/leftMenu.jsp"%>
			...
			<div id="center">
				<div class="path_navi">
					<ul>
						<li class="stitle">세금계산서 발행요청(재사용)</li>
						<li class="navi">홈 > 업무지원 > 각종신청 > 세금계산서 발행요청(재사용)</li>
					</ul>
				</div>
										...
										<c:choose>
											<c:when test="${c.index == 0}">
												...
												<input type="text" class="input02 span_6 " readonly="readonly" name="projectVOList[${c.index}].collect" id="prjcollect${c.index}" 
														value="<print:currency cost='${project.collect}' />" /><span class="pL30"/><img src="../../images/btn/btn_add03.gif"
