			...
			<div id="center_bg">
				...
				<div id="center">
					...
					<div class="section01">
						...
						<!-- 차량정보 시작  -->
						<form:form name="frm" commandName="carRsv" action="${rootPath}/support/insertCarRsv.do" method="POST">
		                    ...
		                    <tbody>
		                    	<tr>
			                    	...
			                    	<td colspan="3" class=" pL10">
			                    		<select class="select01" name="carId" onchange="setInsInfo(this);">
			                    			<option value="">==== 선택 ====</option>
			                    			<c:forEach items="${carList}" var="car">
				                    			<option value="${car.carId}">${car.carTyp}(${car.carId})</option>
			                    			</c:forEach>
			                    		</select>
		                    	...
		                    	<tr>
			                    	...
			                    	<td class="pL10">
			                    		<input type="text" name="userNm" id="userNm" class="input01 span_6 userNameAuto userValidateCheck" onblur="setUserInfo();"/>
		                    	...
		                    	<tr>
			                    	...
			                    	<td colspan="3" class="pL10">
			                    		<input type="text" class="input01 span_4 calGen" maxlength="8" name="stDt"/>
			                    		<select class="select01" name="stTm">
			                    			<c:forEach begin="0" end="23" var="tm">
				                    			<option value="${tm}">${tm}시</option>
			                    			</c:forEach>
			                    		</select>
			                    		~
			                    		<input type="text" class="input01 span_4 calGen" maxlength="8" name="edDt"/>
		                    	...
		                    	<tr>
		                    		...
		                    		<td class="pL10"><input type="text" class="input01 span_29" name="destination"/></td>
		                    		<td class="title">운행예정거리</td>
			                    	<td class="pL10"><input type="text" class="input01 span_5" name="runLength"/> km</td>
		                    	</tr>
		                    	<tr>
		                    		<td class="title">비고</td>
			                    	<td colspan="3" class="pL10 pT10 pB10"><textarea class="span_24" name="rsvNote"></textarea></td>
		                    	</tr>
		                    </tbody>
		                    </table>
						</div>
