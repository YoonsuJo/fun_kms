			...
			<div id="center_bg">
				...
				<div id="center">
					...
					<div class="section01">
						...
						<!-- 장비정보 수리등록 시작  -->
						<form name="frm" commandName="equipRegistRepair" action="${rootPath}/support/insertEquipRepair.do" method="POST">
						<input type="hidden" name="equip_no" value="${equipVO.equip_no}"/>
						<div class="boardWrite02 mB20">
							<table cellpadding="0" cellspacing="0" summary="각 게시물의 상세 내용을 볼 수 있습니다.">
		                    <caption>전산장비 수리등록</caption>
		                    ...
		                    <tbody>
		                    	...
		                    	<tr>
			                    	...
			                    	<td class=" pL10"><input type="text" class="calGen span_29" name="repairDt"/></td>
		                    	</tr>
		                    	<tr>
		                    		<td class="title">수리비용</td>
			                    	<td class=" pL10"><input type="text" class="input01 span_29" name="cost"/></td>
		                    	</tr>
		                    	<tr>
		                    		<td class="title">수리내역</td>
			                    	<td class=" pL10"><input type="text" class="input01 span_29" name="content"/></td>
		                    	</tr>		                    	
		                    	<tr>
		                    		<td class="title">비고</td>
			                    	<td class=" pL10"><input type="text" class="input01 span_29" name="note"/></td>
		                    	</tr>
		                    </tbody>
		                    </table>
						</div>
