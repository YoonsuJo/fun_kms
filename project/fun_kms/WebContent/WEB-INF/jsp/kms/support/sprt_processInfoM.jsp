			...
			<div id="center_bg">
				...
				<div id="center">
					<div class="path_navi">
						...
						<li class="navi">홈 > 업무지원 > 업무처리지원 > 업무참고게시판</li>
						</ul>
					</div>
					...
					<div class="section01">
						...
						<!-- 업무참고게시판은 수정 시, 글의 최초 작성자(frstRegisterId)가 마지막 수정한 사람의 userNo로 변경됩니다. -->
						<input type="hidden" name="frstRegisterId" value="${user.no }"/>
												
						<div class="boardWrite">
							<table cellpadding="0" cellspacing="0" summary="게시물 수정페이지입니다.">
		                    <caption>게시물수정</caption>
		                    <colgroup>
			                    <col class="col100" />
			                    <col width="px" />
		                    </colgroup>
		                    ...
		                    <tbody>
		                    	<tr>
			                    	<td colspan="2">
			                    		<textarea rows="9" cols="100" name="nttCn" id="nttCn"><c:out value="<br/><br/><br/>========== ※ 아래 내용은 이 게시물이 수정되기 이전 내용입니다. ==========<br/>제목 : ${result.nttSj}<br/>작성일자 : ${result.lastUpdusrPnttm}<br/>작성자 : ${result.frstRegisterNm}(${result.frstRegisterUserId})<br/><br/>${result.nttCn}" escapeXml="false" /></textarea>
