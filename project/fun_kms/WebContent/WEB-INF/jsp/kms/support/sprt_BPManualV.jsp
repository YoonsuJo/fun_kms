		                	...
		                	<ul>
		                		<li class="right">
		                			...
		                			<c:if test="${detail.hiddenYn == 'Y'}">
			                			<input type="button" id="btn_show" value="OPEN"/>
			                			<input type="button" id="btn_hidden" value="HIDDEN" style="display:none"/>
		                			</c:if>
		                			<c:if test="${detail.hiddenYn == 'N'}">
		                				<input type="button" id="btn_show" value="OPEN" style="display:none"/>
		                				<input type="button" id="btn_hidden" value="HIDDEN"/>
		                			</c:if>
