...
function insertIpInfo(){
	...
	document.ipFrm.action='<c:url value="${rootPath}/support/insertIpinfo.do"/>';
				...
				<div id="center">
					...
					<div class="section01">
						<form name="ipFrm" method="POST">
								...
								<table cellpadding="0" cellspacing="0" summary="각 게시물의 상세 내용을 볼 수 있습니다.">
									...
									<tbody>
										...
										<tr>
											...
											<td class="pL10">
												<input type="number" oninput="handleOnInput(this, 3)" name="ip" class="span_7" min="2" max="254" value=""/>
												범위) 2~254
											</td>
										</tr>
										<tr>
											...
											<td class="pL10">
												<input type="text" name="ipUserList" id="ipUserList" class="input_left write_input8 userNamesAuto userValidateCheck" value=""/>
										...
										<tr>
											...
											<td class="pL10">
												<input type="text" class="span_10" name="ipPurpose" value=""/>
												ex) 업무용, 개발용
											</td>
										</tr>
									</tbody>
							...
							<!-- S: button -->
							<div class="btn_area">
								<img src="../../images/btn/btn_regist.gif" onclick="javascript:insertIpInfo();" class="cursorPointer"/>
