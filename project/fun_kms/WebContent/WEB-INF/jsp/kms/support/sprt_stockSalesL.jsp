			...
			<div id="center">
				<div class="path_navi">
					<ul>
						...
						<li class="navi">홈 > 업무지원 > 전체현황 > 판매현황</li>
					</ul>
				</div>
				<!-- S: section -->
				<div class="section01">
					<ul>
						<li class="th_stitle04 mB10">판매현황</li>
						<c:choose>
						<c:when test="${new == 'new'}">
							<li class="th_navi04"><a href="${rootPath}/support/stockSalesL.do">구 판매현황 바로가기</a></li>
						</c:when>
						<c:otherwise>
							<li class="th_navi04"><a href="${rootPath}/support/stockL.do?type=sale">신규 재고현황 바로가기</a></li>
						</c:otherwise>
						</c:choose>
					</ul>
					...
					<div class="boardList mB20">
	                    ...
	                    <tbody>
	                    	<c:forEach items="${resultList}" var="result" varStatus="c">
	                   		<tr>
	                   			...
	                   			<td class="txt_center">
	                   				<c:choose>
									<c:when test="${new == 'new'}">
										<a href="${rootPath}/support/stockDetailList.do?type=sell&itemCode=${result.itemCode}">${result.itemName }</a>
									</c:when>
									<c:otherwise>
										<a href="${rootPath}/support/stockDetailListOld.do?type=sell&itemCode=${result.itemCode}">${result.itemName }</a>
									</c:otherwise>
									</c:choose>
	                   			</td>
	                   			<td class="txt_center">${result.count2 }</td>
	                    	...
	                    	<tr>
	                    		<td></td>
	                    		<td class="txt_center" colspan="4">총 판매금액</td>
