			...
			<div id="center_bg">
				...
				<div id="center">
					...
					<div class="section01">
						...
						<!-- 차량정보 시작  -->
						<form:form name="frm" commandName="carFix" action="${rootPath}/support/updateCarFixInfo.do" method="POST">
						...
						<div class="boardWrite02 mB20">
		                    ...
		                    <tbody>
		                    	...
		                    	<tr>
			                    	...
			                    	<td class=" pL10">
			                    		<input type="text" class="input01 span_6 userNameAuto" name="userNm" id="userNm" value="${result.userNm}(${result.userId})" <c:if test="${user.admin == false}">readonly="readonly"</c:if>/>
		                    	...
		                    	<tr>
			                    	...
			                    	<td class=" pL10"><input type="text" class="input01 span_6 calGen" name="fixDate" value="${result.fixDate}"/></td>
		                    	</tr>
		                    	<tr>
		                    		<td class="title">운행거리</td>
			                    	<td class=" pL10"><input type="text" class="input01 span_6" name="runLength" value="${result.runLength}"/> km</td>
		                    	</tr>
		                    	<tr>
		                    		<td class="title">정비항목</td>
			                    	<td class=" pL10"><input type="text" class="input01 span_24" name="fixItem" value="${result.fixItem}"/></td>
		                    	</tr>
		                    	<tr>
		                    		<td class="title">정비 상세내역</td>
			                    	<td class=" pL10 pT10 pB10"><textarea class="span_24" name="fixItemDetail">${result.fixItemDetail}</textarea></td>
		                    	</tr>
		                    	<tr>
		                    		<td class="title">비고</td>
			                    	<td class=" pL10 pT10 pB10"><textarea class="span_24" name="fixNote">${result.fixNote}</textarea></td>
		                    	</tr>
		                    </tbody>
		                    </table>
						</div>
