...
function updateTaxPublish() {
	...
	document.taxPublishVO.action = '<c:url value="${rootPath}/support/taxPublishU.do" />';
		...
		<%@ include file="../common/menu/leftMenu.jsp"%>
			...
			<div id="center">
				...
				<div class="section01">
					...
					<input type="hidden" name="returnUrl" value="<c:url value='${rootPath}/support/taxPublishM.do'/>"/>
					...
					<!-- 버튼 시작 -->
					<div class="btn_area">
						<img src="../../images/btn/btn_regist.gif" onclick="javascript:updateTaxPublish();" class="cursorPointer"/>
