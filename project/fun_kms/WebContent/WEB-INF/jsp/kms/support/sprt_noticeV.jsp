...
function answerArticle() {
	document.frm.action = "<c:url value='${rootPath}/support/addReplyBoardArticle.do'/>";
	document.frm.submit();
}
				...
				<div id="center">
					<div class="path_navi">
						<ul>
							...
							<li class="navi">홈 > 업무지원 > 업무처리지원 > ${brdMstrVO.bbsNm}</li>
						</ul>
					</div>
					...
					<div class="section01">
		                ...
		                <div class="btn_area02">
		                	...
		                	<c:if test="${user.no == result.frstRegisterId || user.admin}">
