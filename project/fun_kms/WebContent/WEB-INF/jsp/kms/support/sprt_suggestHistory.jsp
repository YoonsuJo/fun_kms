		...
		<tbody>
			...
			<c:forEach items="${hList}" var="history">
				<tr>
					...
					<td class="txt_center">${history.sgstStPrint}</td>
		...
		<tr>
			...
			<textarea name="note" ></textarea>
             ...
             <div class="btn_area07">
				<a href="javascript:insertHistory('C')"><img src="${imagePath}/btn/btn_choose.gif"/></a>
				<a href="javascript:insertHistory('R')"><img src="${imagePath}/btn/btn_dismiss.gif"/></a>
				<a href="javascript:insertHistory('H')"><img src="${imagePath}/btn/btn_defer.gif"/></a>
				<a href="javascript:insertHistory('F')"><img src="${imagePath}/btn/btn_finish.gif"/></a>
			</div>
</div>
<!--// 의견 끝  -->
</c:if>
