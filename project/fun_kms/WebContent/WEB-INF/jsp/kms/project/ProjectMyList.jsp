...
function MoveDate(dateMove) {
	...
	*/
	...
	form.action = "${rootPath}/project/listMyProject.do";
	form.submit();
}
			...
			<div id="center">
				...
				<form name="searchVO" id="searchVO" method="POST" >
					...
					<tbody>
						<tr>
							...
							<td  class="searchInput">기준일 : 
								...
								<input type="text" class="calGen w70 input03" name="searchDate" value="${searchVO.searchDate}" readonly="readonly" 
					...
					<c:if test="${user.admin == true || user.isProjectadmin == 'Y'}">
						<input type="button" value="프로젝트관리" class="fr btn_gray" onclick="location.href='/project/listProject.do'" />
					</c:if>
