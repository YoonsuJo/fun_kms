...
function mailDelete() {
	if (confirm('<spring:message code="common.delete.msg" />')) {
		document.frm.action = "<c:url value='${rootPath}/community/deleteRecieveMailList.do'/>";
		document.frm.submit();
	}
}
		...
		<%@ include file="../common/menu/leftMenu.jsp"%>
			...
			<div id="center_bg">
				...
				<div id="center" style="padding-bottom:80px">
					<div class="path_navi">
						<ul>
							<li class="stitle">받은편지</li>
							<li class="navi">홈 > 커뮤니티 > 사내메일 > 받은편지</li>
						</ul>
					</div>
					...
					<div class="section01">
						...
						<div class="boardView">
		                    ...
		                    <tbody>
		                    	<tr>
			                    	<td colspan="2" id="mailCn" class="H300"><c:out value="${result.mailCn}" escapeXml="false"/></td>
		                    	</tr>
		                    </tbody>
		                    </table>
						</div>
		                ...
		                <div class="btn_area02">
		                	...
		                	<a href="javascript:scrapArticle('MAIL', '${result.mailId}')"><img src="${imagePath}/btn/btn_scrap.gif"/></a>
