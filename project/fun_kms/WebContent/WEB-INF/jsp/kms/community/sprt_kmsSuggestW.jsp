...
function register() {
	...
	document.board.action = "<c:url value='${rootPath}/support/insertBoardArticle.do'/>";
	<c:if test="${isReply == 'Y'}">
	document.board.action = "<c:url value='${rootPath}/support/replyBoardArticle.do'/>";
	</c:if>
	document.board.submit();					
}
function listArticle() {
	document.board.action = "<c:url value='${rootPath}/support/selectBoardList.do'/>";
	document.board.submit();
}
</script>
</head>
			...
			<div id="center_bg">
				...
				<div id="center">
					...
					<div class="section01">
						...
						<input type="hidden" name="exChk" value="E" />
