...
<input type="hidden" name="param_returnUrl" value="<c:out value='${param_returnUrl}'/>" />
...
<div class="morning">
    ...
    <div class="morning_con">
        ...
        <p class="greeting_tl">오늘의 한마음 첫 출근자입니다. 한마음 임직원에게 아침인사를 남겨주세요.</p>
        	<div class="regist" >
            	<textarea name="nttSj" id="nttSj"></textarea>
            </div>
        </div>
        <div class="btn_area">
        	<a href="javascript:register();" class="btn"><img src="${imagePath}/btn/btn_regist.gif" alt="등록" /></a>
