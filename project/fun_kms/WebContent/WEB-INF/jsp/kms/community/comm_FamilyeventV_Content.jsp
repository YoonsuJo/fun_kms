...
<%@ taglib prefix="print" uri="print" %>
						...
						function listArticle() {
							...
							<p class="th_stitle">경조사게시판(일괄 읽기)<span class="th_count">(조회수 <c:out value="${result.inqireCo}"/>)</span></p>
							...
							<div class="boardView">
			                    ...
			                    <thead>
			                        ...
			                        <tr>
				                    	...
				                    	<th class="write_info">경조일시</th>
				                    	<th class="write_info2"><c:out value="${result.exDtPrint}" /> <c:out value="${result.exHm}" />시</th>
			                        </tr>
			                    </thead>
