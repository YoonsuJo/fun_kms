...
function view(nttId, bbsId, readBool) {
	...
	document.subForm.action = "${rootPath}/community/selectBoardArticle.do";
	...
	<div id="container">
		...
		<%@ include file="../common/menu/leftMenu.jsp"%>
			...
			<div id="center" style="padding-bottom:80px">
				<div class="path_navi">
					<ul>
						<li class="stitle">경조사게시판</li>
						<li class="navi">홈 > 커뮤니티 > 게시판 > 경조사</li>
					</ul>
				</div>
				
				<span class="stxt">임직원들의 경조사 소식을 공유하는 공간입니다.</span>   				
				...
				<div class="section01">
					...
					<div class="boardList mB20">
						<table cellpadding="0" cellspacing="0" summary="경조사게시판 목록입니다.">
						<caption>경조사게시판</caption>
						<colgroup>						
							<col class="col40" />
							<col width="px" />
							<col class="col120" />
						...
						<tbody>
							<c:forEach items="${resultList}" var="result" varStatus="c">
								<tr>
									...
									<td>
<!--										<a href="javascript:view('${result.nttId}','${result.bbsId}','${result.readBool}');">-->
									...
									<td class="txt_center<c:if test="${result.exDt >= todayDate}"> txt_blue</c:if>">${result.exDtPrint}<c:if test="${not empty result.exHm}"> ${result.exHm}시</c:if></td>
									<td class="txt_center">${result.inqireCo}</td>
								</tr>
							</c:forEach>
						</tbody>
						</table>
