...
function register() {
	...
	document.board.action = "<c:url value='${rootPath}/community/imageI.do'/>";
	document.board.submit();					
}
function listArticle() {
	document.board.action = "<c:url value='${rootPath}/community/imageL.do'/>";
	document.board.submit();
}
</script>
</head>
		                    ...
		                    <thead>
								...
								<tr>
									...
									<th class="write_info2">
										...
										<span>※ 목록에 보이게 될 썸네일 이미지입니다.</span>
									</th>
		                        </tr>	                        
		                    </thead>
		                    <tbody>
