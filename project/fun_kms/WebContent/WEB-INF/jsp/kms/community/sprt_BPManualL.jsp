...
function clickSearchCondition() {
	var condition = $('.top_search07 input[name=searchCondition]:checked').val();
	var searchKeyword = $('.top_search07 input[name=searchKeyword]');
	if (condition == 2) {
						...
						<tbody>
							<tr>
								<td class="pT5">
									...
									<label><input type="radio" name="searchCondition" value="0" onclick="javascript:clickSearchCondition();" <c:if test="${bpmVO.searchCondition == '0'}">checked="checked"</c:if>/>제목</label><span class="pL7"></span>
									<label><input type="radio" name="searchCondition" value="1" onclick="javascript:clickSearchCondition();" <c:if test="${bpmVO.searchCondition == '1'}">checked="checked"</c:if>/>제목+내용</label><span class="pL7"></span>
									<label><input type="radio" name="searchCondition" value="2" onclick="javascript:clickSearchCondition();" <c:if test="${bpmVO.searchCondition == '2'}">checked="checked"</c:if>/>작성자</label>
