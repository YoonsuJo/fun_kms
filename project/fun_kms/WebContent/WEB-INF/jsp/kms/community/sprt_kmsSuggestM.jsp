...
function update() {
	...
	document.board.action = "<c:url value='${rootPath}/support/updateBoardArticle.do'/>";
			...
			<div id="center_bg">
				...
				<div id="center">
					...
					<div class="section01">
						...
						<p class="th_stitle">KMS개선요청</p>
						
						<!-- 게시판 시작  -->
						<form:form commandName="commBoard" name="board" method="post" enctype="multipart/form-data" >
						<input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>"/>
						<input type="hidden" name="returnUrl" value="<c:url value='${rootPath}/support/forUpdateBoardArticle.do'/>"/>
