...
<table cellpadding="0" cellspacing="0" >
	...
	<tbody>
		...
		<tr>
			...
			<td class="pL10">
				<span class="salesDoc.cost"></span>원(부가세별도)
			</td>
			<td class="title">매출일</td>
			<td class="txt_center">
				<span class="salesDoc.stDt hidden"></span>
				<span class="salesDoc.stDtLongString"></span>
			</td>
			<td class="title">최종수금예정일</td>
			<td class="txt_center">
				<span class="salesDoc.colDueDt hidden"></span>
...
<p class="th_stitle2 mB10">사내매입 <span class="purchaseInSum" style="margin-left:30px;"></span></p>
<table cellpadding="0" cellspacing="0" summary="각 게시물의 상세 내용을 볼 수 있습니다.">
	<colgroup>
		<col class="col80" />
		<col class="col100" />
...
<table cellpadding="0" cellspacing="0" summary="각 게시물의 상세 내용을 볼 수 있습니다.">
	...
	<tbody>
		<tr>
			...
			<td class="pR5 txt_right"><span class="span_9 cost"></span></td>
