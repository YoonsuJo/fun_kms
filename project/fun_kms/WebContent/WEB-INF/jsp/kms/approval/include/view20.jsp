...
<!-- 종합매출보고서 JAVA 단에서 보내준 JSONObject 를 갖고 approval20.jquery.js 에서 계산해서 테이블 생성 -->
<div id="salesDocViewD">
		...
		<table id="salesDocWriteT" cellpadding="0" cellspacing="0"
			...
			<tbody>
				...
				<tr>
					...
					<td class="pL10">
						<span class="span_9 salesDoc.deposit" /></span>원 (부가세별도)</td>
					<td class="title">계약기간</td>
					<td class="pL10">
						<span class="span_5 salesDoc.stDt hidden"> </span>
						<span class="salesDoc.stDtLongString"></span>
						 ~ 
						<span class="span_5 salesDoc.edDt hidden"> </span>
						<span class="salesDoc.edDtLongString"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="pL10">
						<span class="span_5 salesDoc.colDueDt hidden"> </span>
						<span class="salesDoc.colDueDtLongString"></span>
				</tr>
			</tbody>
		</table>
	</div>
	...
	<div class="boardWrite02 mB20" id="purchaseInGeneralD">
		<p class="th_stitle2 mB10">
			사내매입 <span class="purchaseInSum" style="margin-left:30px;"></span>
		</p>
