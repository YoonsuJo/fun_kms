...
function updateDoc(){
	...
	if($('#salesDocWriteD input[name=salesDoc\\.stDt]').val().length==8 
		...
		var colDueDt = $('#salesDocWriteD input[name=salesDoc\\.colDueDt]').val();
		...
		<table id="salesDocWriteT" cellpadding="0" cellspacing="0" summary="각 게시물의 상세 내용을 볼 수 있습니다.">
			...
			<tbody>
				...
				<tr>
					...
					<td class="pL10"><input type="text" name="salesDoc.deposit" class="span_7" value="0"/> 원(부가세별도)</td>
				...
				<tr>
					...
					<td class="pL10">
						<input type="text" name="salesDoc.colDueDt" class="span_4 calGen" />
					</td>
				</tr>
			</tbody>
		</table>
