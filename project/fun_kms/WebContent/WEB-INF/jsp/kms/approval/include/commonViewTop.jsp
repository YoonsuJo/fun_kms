...
<div class="boardWrite02 mB20">
	<table cellpadding="0" cellspacing="0" summary="각 게시물의 상세 내용을 볼 수 있습니다.">
                ...
                <tbody>
                	...
                	<tr>
	                 	<td class="title">결재진행상태</td>
	                 	<td class="pL10">
	                 		${commonDoc.docStatPrint}(<print:date date="${commonDoc.preAppDtLong}" printMin='Y'/>)
	                 	</td>
                	</tr>
			       	<c:if test="${appTyp.templtId==6}">
			       		<tr>
			            	<td class="title">프로젝트</td>
			             	<td class="pL10">		
			             	<a href="${rootPath}/cooperation/selectProjectV.do?prjId=${commonDoc.prjIdDoc}">[${commonDoc.prjCdDoc}] ${commonDoc.prjNmDoc}</a>	             		
			             	</td>
			            </tr>	
				       	<tr>
				        	<td class="title">수신메일주소</td>
				        	<td class="pL10">${commonDoc.emailAddr}			        		
				        	</td>
				       	</tr>				       
			       	</c:if> 
                </tbody>
