	...
	<table cellpadding="0" cellspacing="0">
		...
		<tbody>
			...
			<tr>
				...
				<td class="pL10"><input type="text" name="salesDoc.cost" class="w100" value="0"/> 원(부가세별도)</td>
				<td class="title">매출일</td>
				<td class="txt_center"><input type="text" name="salesDoc.stDt" class="w100 calGen txt_center" /></td>
				<td class="title">최종수금예정일</td>
				<td class="txt_center"><input type="text" name="salesDoc.colDueDt" class="w100 calGen txt_center" /></td>
			</tr>
		</tbody>
	</table>
	</div>
		...
		<table cellpadding="0" cellspacing="0">
			...
			<tbody>
				<tr>
					...
					<td class="pL10"><input type="text" name="expense.cost" class="w60 txt_right pR5" value="0"/>
					원</td>
					<td class="title">비고</td>
					<td class="pL10"><input type="text" name="expense.ct" class="w500" /></td>
				</tr>
			</tbody>
		</table>
		</div>
