...
<table cellpadding="0" cellspacing="0" summary="각 게시물의 상세 내용을 볼 수 있습니다.">
	...
	<tbody>
		<tr>
			...
			<c:forEach begin="0" end="5" varStatus="status">
				<td class="txt_center" <c:if test="${status.index==5}">td_last</c:if>>
					<input type="text" name="salesOutList" value ="<print:currency cost='${specificVOList[status.index].salesOut}' divideBy="1000" printCipher="false"/>"
		...
		<tr>
			...
			<c:forEach begin="0" end="5" varStatus="status">
				<td class="txt_center" <c:if test="${status.index==5}">td_last</c:if>>
					<input type="text" name="salesInList" value ="<print:currency cost='${specificVOList[status.index].salesIn}' divideBy="1000" printCipher="false"/>"
					class="span_5 currency1000" />
				</td>
			</c:forEach>
		</tr>
	...
	<tbody>
		<tr>
			...
			<c:forEach begin="0" end="11" varStatus="status">
				<td class="txt_center salesOut month${status.count }">
					<print:currency cost='${specificVOList[status.index].salesOut}' divideBy='1000000'/>
				</td>
			</c:forEach>
			<td class="td_last txt_center salesOut horizonTotal">
		...
		<tr>
			<td class="txt_center">매출(사내)</td>
			<c:forEach begin="0" end="11" varStatus="status">
				<td class="txt_center salesIn month${status.count }">
					<print:currency cost='${specificVOList[status.index].salesIn}' divideBy='1000000'/>
				</td>
			</c:forEach>
			<td class="td_last txt_center salesIn horizonTotal">
