...
<input type="button" value="adolys" onclick="login('adolys','aa');" style="width:45%; height:200px;"/>
<input type="button" value="blindblue" onclick="login('blindblue','bb');" style="width:45%; height:200px;"/>
<input type="button" value="a" onclick="login('aa','a');" style="width:45%; height:200px;"/>
<input type="button" value="b" onclick="login('bb','a');" style="width:45%; height:200px;"/>
</body>
</html>
