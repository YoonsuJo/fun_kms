...
public class SupportCommentController {
     ...
     * @throws Exception
     */
    @RequestMapping(value={"/support/selectCommentList.do", "/expansion/selectCommentList.do"})
    public String selectCommentList(@ModelAttribute("searchVO") CommentVO commentVO, HttpServletRequest req, ModelMap model) throws Exception {
		...
		if (!commentVO.getCommentNo().equals("")) {
		    return "forward:/support/selectSingleComment.do";
		}
     ...
     * @throws Exception
     */
    @RequestMapping("/support/insertComment.do")
    public String insertComment(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") CommentVO commentVO,
		...
		return "redirect:/support/selectBoardArticle.do?bbsId=" + comment.getBbsId() + "&nttId=" + comment.getNttId();
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/support/deleteComment.do")
    public String deleteComment(@ModelAttribute("searchVO") CommentVO commentVO, @ModelAttribute("comment") Comment comment, ModelMap model) throws Exception {
		...
		return "forward:/support/selectBoardArticle.do";
     ...
     * @throws Exception
     */
    @RequestMapping("/support/selectSingleComment.do")
     ...
     * @throws Exception
     */
    @RequestMapping("/support/updateComment.do")
