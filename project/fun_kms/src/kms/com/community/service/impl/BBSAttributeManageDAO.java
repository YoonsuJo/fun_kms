 ...
 * </pre>
 */
@Repository("KmsBBSAttributeManageDAO")
public class BBSAttributeManageDAO extends EgovAbstractDAO {
    ...
    public void deleteBBSMasterInf(BoardMaster boardMaster) throws Exception {
    	update("CommAttributeManageDAO.deleteBBSMasterInf", boardMaster);
    }
    ...
    public String insertBBSMasterInf(BoardMaster boardMaster) throws Exception {
    	return (String)insert("CommAttributeManageDAO.insertBBSMasterInf", boardMaster);
    }
    ...
    public BoardMasterVO selectBBSMasterInf(BoardMaster vo) throws Exception {
    	return (BoardMasterVO)selectByPk("CommAttributeManageDAO.selectBBSMasterInf", vo);
    }
    ...
    public List<BoardMasterVO> selectBBSMasterInfs(BoardMasterVO vo) throws Exception {
    	return list("CommAttributeManageDAO.selectBBSMasterInfs", vo);
    }
    ...
    public int selectBBSMasterInfsCnt(BoardMasterVO vo) throws Exception {
    	return (Integer)getSqlMapClientTemplate().queryForObject("CommAttributeManageDAO.selectBBSMasterInfsCnt", vo);
    }
    ...
    public void updateBBSMasterInf(BoardMaster boardMaster) throws Exception {
    	update("CommAttributeManageDAO.updateBBSMasterInf", boardMaster);
    }
    ...
    public List<BoardMasterVO> selectAllBBSMasteInf(BoardMasterVO vo) throws Exception {
		...
		return list("CommAttributeManageDAO.selectAllBBSMaster", vo);
    }
    ...
    public List<BoardMasterVO> selectBdMstrListByTrget(BoardMasterVO vo) throws Exception {
    	return list("CommAttributeManageDAO.selectBdMstrListByTrget", vo);
    }
    ...
    public int selectBdMstrListCntByTrget(BoardMasterVO vo) throws Exception {
    	return (Integer)getSqlMapClientTemplate().queryForObject("CommAttributeManageDAO.selectBdMstrListCntByTrget", vo);
    }
    ...
    public List<BoardMasterVO> selectAllBdMstrByTrget(BoardMasterVO vo) throws Exception {
    	return list("CommAttributeManageDAO.selectAllBdMstrByTrget", vo);
    }
    ...
    public List<BoardMasterVO> selectNotUsedBdMstrList(BoardMasterVO vo) throws Exception {
    	return list("CommAttributeManageDAO.selectNotUsedBdMstrList", vo);
    }
    ...
    public int selectNotUsedBdMstrListCnt(BoardMasterVO vo) throws Exception {
    	return (Integer)getSqlMapClientTemplate().queryForObject("CommAttributeManageDAO.selectNotUsedBdMstrListCnt", vo);
    }

    
    
	public List<BoardMasterVO> selectBoardMasterList(BoardMasterVO searchVO) {
		return list("CommAttributeManageDAO.selectBoardMasterList", searchVO);
	}		
}
