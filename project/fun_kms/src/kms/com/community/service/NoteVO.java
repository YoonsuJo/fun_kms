...
/**
 * @Class Name : TblNotesendDefaultVO.java
 * @Description : TblNotesend Default VO class
...
public class NoteVO extends Note implements Serializable {
    ...
    public String[] getNoteIdList() {
    	return noteIdList;
    }
    
    public void setNoteIdList(String[] noteIdList) {
