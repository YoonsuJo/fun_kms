...
public class BoardVO extends Board implements Serializable {
    ...
    private String[] searchStatList = {"P"};
	...
	private String readBool = "N";
	private String fromUnread = "N";
    /**
	...
	/**
	 * @return the searchStatList
	 */
	public String[] getSearchStatList() {
		return searchStatList;
	}
	public String getSearchStatListPrint() {
		String r = "";
		for (int i=0; i<searchStatList.length; i++) {
			if (i!=0) {
				r += ",";
			}
			r += searchStatList[i];
	...
	/**
	 * @param searchStatList the searchStatList to set
	 */
    ...
    public String getFrstRegisterUserId() {
		return frstRegisterUserId;
	}

	public void setFrstRegisterUserId(String frstRegisterUserId) {
		this.frstRegisterUserId = frstRegisterUserId;
	}
    ...
    /**
     * commentCount attribute 값을 설정한다.
    ...
    /**
     * readBool attribute 값을 설정한다.
     * @param readBool the readBool to set
     */
	...
	/**
	 * @param fromUnread the fromUnread to set
	 */
	public void setFromUnread(String fromUnread) {
	...
	/**
	 * @return the bbsTyCodeArray
	 */
	public String[] getBbsTyCodeArray() {
		return bbsTyCodeArray;
	}

	/**
	 * @param bbsTyCodeArray the bbsTyCodeArray to set
	 */
	public void setBbsTyCodeArray(String[] bbsTyCodeArray) {
		this.bbsTyCodeArray = bbsTyCodeArray;
	}
}
