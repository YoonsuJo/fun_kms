...
public class Comment implements Serializable {
    ...
    /** 최후 업데이트 시점 */
    private String lastUpdaterPnttm = "";
	 ...
	 * @return the wrterNo
	 */
	public Integer getWrterNo() {
		return wrterNo;
	}

	/**
	 * @param wrterNo the wrterNo to set
	 */
	public void setWrterNo(Integer wrterNo) {
		this.wrterNo = wrterNo;
	}
    ...
    public String getCommentCnPrint() {
    	return commentCn.replace("\r\n", "<br/>");
    }
    ...
    public String getLastUpdaterPnttm() {
    	if (lastUpdaterPnttm == null || lastUpdaterPnttm.equals(""))
    		return getFrstRegisterPnttm();
		return lastUpdaterPnttm;
	}

	public void setLastUpdaterPnttm(String lastUpdaterPnttm) {
		this.lastUpdaterPnttm = lastUpdaterPnttm;
	}
