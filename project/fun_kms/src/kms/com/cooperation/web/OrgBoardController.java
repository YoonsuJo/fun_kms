...
public class OrgBoardController {
    ...
    @RequestMapping("/cooperation/selectOrgBoardMain.do")
    public String selectOrgBoardMain(@ModelAttribute("searchVO") BoardVO boardVO, HttpServletRequest req, ModelMap model) throws Exception {
    	MemberVO user = SessionUtil.getMember(req);

		boardVO.setBbsId("BBSMSTR_000000000084");
		boardVO.setFrstRegisterId(user.getStringNo());
		boardVO.setSearchKeyword(user.getStringNo());
//		boardVO.setSearchOrgIdList(CommonUtil.makeValidIdList(boardVO.getSearchOrgId()));

		Map<String, Object> result = bbsMngService.selectOrgBoardMain(boardVO);

		model.addAttribute("result", result);
    	//boardVO.setSearchStatList(new String[]{"P","E","S"});
    	return "cooperation/coop_orgBoardMain";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cooperation/selectOrgBoardList.do") 
    public String selectBoardArticles(@ModelAttribute("searchVO") BoardVO boardVO, HttpServletRequest req, ModelMap model) throws Exception {
		...
		if (masterVo.getBbsTyCode().equals("COOP") && masterVo.getBbsAttrbCode().equals("ORGBBS")) {
			return "cooperation/coop_orgBoardL";
		} else {
     ...
     * @throws Exception
     */
    @RequestMapping("/cooperation/insertOrgBoardView.do")
    public String addBoardArticle(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		if (masterVo.getBbsTyCode().equals("COOP") && masterVo.getBbsAttrbCode().equals("ORGBBS")) {
			return "cooperation/coop_orgBoardW";
		} else {
    ...
    @RequestMapping("/cooperation/insertOrgBoard.do")
    public String insertBoardArticle(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
		...
		//status.setComplete();
		return "redirect:/cooperation/selectOrgBoardList.do?orgnztId=" + board.getOrgnztId();
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cooperation/selectOrgBoard.do")
    public String selectBoardArticle(@ModelAttribute("searchVO") BoardVO boardVO, HttpServletRequest req, ModelMap model) throws Exception {
		...
		if (masterVo.getBbsTyCode().equals("COOP") && masterVo.getBbsAttrbCode().equals("ORGBBS")) {
			return "cooperation/coop_orgBoardV";
		} else {
     ...
     * @throws Exception
     */
    @RequestMapping("/cooperation/updateOrgBoardView.do")
    public String selectBoardArticleForUpdt(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") BoardVO vo,
		...
		if (masterVo.getBbsTyCode().equals("COOP") && masterVo.getBbsAttrbCode().equals("ORGBBS")) {
			return "cooperation/coop_orgBoardM";
		} else {
     ...
     */
    @SuppressWarnings("unchecked")
    @RequestMapping("/cooperation/updateOrgBoard.do")
    public String updateBoardArticle(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
		...
		return "forward:/cooperation/selectOrgBoard.do";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cooperation/deleteOrgBoard.do")
    public String deleteBoardArticle(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") Board board,
		...
		return "redirect:/cooperation/selectOrgBoardList.do?orgnztId=" + boardVO.getOrgnztId();
    }
