...
public class WeekReportController {
     ...
     * @throws Exception
     */
    @RequestMapping("/cooperation/selectWeekReportList.do") 
    public String selectBoardArticles(@ModelAttribute("searchVO") BoardVO boardVO, HttpServletRequest req, ModelMap model) throws Exception {
		...
		boardVO.setBbsId("BBSMSTR_000000000071");
		...
		if (masterVo.getBbsTyCode().equals("COOP") && masterVo.getBbsAttrbCode().equals("WKRPRT")) {
			return "cooperation/coop_weekReportL";
		} else {
     ...
     * @throws Exception
     */
    @RequestMapping("/cooperation/insertWeekReportView.do")
    public String addBoardArticle(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		if (masterVo.getBbsTyCode().equals("COOP") && masterVo.getBbsAttrbCode().equals("WKRPRT")) {
			return "cooperation/coop_weekReportW";
		} else {
    ...
    @RequestMapping("/cooperation/insertWeekReport.do")
    public String insertBoardArticle(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
		...
		//status.setComplete();
		return "redirect:/cooperation/selectWeekReportList.do";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cooperation/selectWeekReport.do")
    public String selectBoardArticle(@ModelAttribute("searchVO") BoardVO boardVO, HttpServletRequest req, ModelMap model) throws Exception {
		...
		if (masterVo.getBbsTyCode().equals("COOP") && masterVo.getBbsAttrbCode().equals("WKRPRT")) {
			return "cooperation/coop_weekReportV";
		} else {
     ...
     * @throws Exception
     */
    @RequestMapping("/cooperation/updateWeekReportView.do")
    public String selectBoardArticleForUpdt(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") BoardVO vo,
		...
		if (masterVo.getBbsTyCode().equals("COOP") && masterVo.getBbsAttrbCode().equals("WKRPRT")) {
			return "cooperation/coop_weekReportM";
		} else {
     ...
     */
    @SuppressWarnings("unchecked")
    @RequestMapping("/cooperation/updateWeekReport.do")
     ...
     * @throws Exception
     */
    @RequestMapping("/cooperation/deleteWeekReport.do")
