...
public class AdminCommentController {
     ...
     * @throws Exception
     */
    @RequestMapping("/admin/selectCommentList.do")
    public String selectCommentList(@ModelAttribute("searchVO") CommentVO commentVO, HttpServletRequest req, ModelMap model) throws Exception {
		...
		if (!commentVO.getCommentNo().equals("")) {
		    return "forward:/admin/selectSingleComment.do";
		}
     ...
     * @throws Exception
     */
    @RequestMapping("/admin/insertComment.do")
    public String insertComment(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") CommentVO commentVO,
		...
		if (isAuthenticated) {
			...
			if (masterVo.getBbsTyCode().equals("ADMN") && masterVo.getBbsAttrbCode().equals("ADMIN")) {
		...
		return "redirect:/admin/selectBoardArticle.do?bbsId=" + comment.getBbsId() + "&nttId=" + comment.getNttId();
    }
    ...
    public String deleteComment(@ModelAttribute("searchVO") CommentVO commentVO, @ModelAttribute("comment") Comment comment, ModelMap model) throws Exception {
		...
		return "forward:/admin/selectBoardArticle.do";
     ...
     * @throws Exception
     */
    @RequestMapping("/admin/selectSingleComment.do")
     ...
     * @throws Exception
     */
    @RequestMapping("/admin/updateComment.do")
