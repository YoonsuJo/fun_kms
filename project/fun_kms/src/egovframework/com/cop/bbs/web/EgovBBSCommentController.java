...
public class EgovBBSCommentController {
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/selectCommentList.do")
	...
	if (commentVO.getType().equals("head")) {
	    return "cop/bbs/EgovCommentList";
	}
	////----------------------------------------
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/anonymous/selectCommentList.do")
	...
	// 수정을 위한 처리
	if (!commentVO.getCommentNo().equals("")) {
	    return "forward:/cop/bbs/anonymous/selectSingleComment.do";
	}
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/selectSingleComment.do")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/anonymous/selectSingleComment.do")
