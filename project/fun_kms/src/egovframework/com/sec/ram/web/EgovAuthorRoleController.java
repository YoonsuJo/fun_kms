...
public class EgovAuthorRoleController {
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/cmm/sec/ram/EgovAuthorRoleList.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value="/cmm/sec/ram/EgovAuthorRoleInsert.do")
	public String insertAuthorRole(@RequestParam("authorCode") String authorCode,
		...
		return "forward:/cmm/sec/ram/EgovAuthorRoleList.do";
	}    
}