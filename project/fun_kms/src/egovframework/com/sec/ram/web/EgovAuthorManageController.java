...
public class EgovAuthorManageController {
	 ...
	 * @exception Exception
	 */
    @RequestMapping("/cmm/sec/ram/EgovAuthorListView.do")
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/cmm/sec/ram/EgovAuthorList.do")
	 ...
	 * @exception Exception
	 */   
    @RequestMapping(value="/cmm/sec/ram/EgovAuthor.do")
	 ...
	 * @exception Exception
	 */     
    @RequestMapping("/cmm/sec/ram/EgovAuthorInsertView.do")
	 ...
	 * @exception Exception
	 */ 
    @RequestMapping(value="/cmm/sec/ram/EgovAuthorInsert.do")
    public String insertAuthor(@ModelAttribute("authorManage") AuthorManage authorManage, 
		...
		if (bindingResult.hasErrors()) { 
	        ...
	        return "forward:/cmm/sec/ram/EgovAuthor.do";
		}
    }
	 ...
	 * @exception Exception
	 */  
    @RequestMapping(value="/cmm/sec/ram/EgovAuthorDelete.do")
    public String deleteAuthor(@ModelAttribute("authorManage") AuthorManage authorManage, 
        ...
        return "forward:/cmm/sec/ram/EgovAuthorList.do";
    }   
	 ...
	 * @exception Exception
	 */  
    @RequestMapping(value="/cmm/sec/ram/EgovAuthorListDelete.do")
