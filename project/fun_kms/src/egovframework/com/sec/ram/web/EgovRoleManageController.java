...
public class EgovRoleManageController {
	 ...
	 * @exception Exception
	 */
    @RequestMapping("/cmm/sec/ram/EgovRoleListView.do")
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/cmm/sec/ram/EgovRoleList.do")
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/cmm/sec/ram/EgovRole.do")
	public String selectRole(@RequestParam("roleCode") String roleCode,
        ...
        return "/cmm/sec/ram/EgovRoleUpdate";
	}
	 ...
	 * @exception Exception
	 */     
    @RequestMapping("/cmm/sec/ram/EgovRoleInsertView.do")
    public String insertRoleView(@ModelAttribute("authorManageVO") AuthorManageVO authorManageVO, 
        ...
        return "/cmm/sec/ram/EgovRoleInsert";
    }
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/cmm/sec/ram/EgovRoleInsert.do")
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/cmm/sec/ram/EgovRoleUpdate.do")
	public String updateRole(@ModelAttribute("roleManage") RoleManage roleManage,
    	...
    	return "forward:/cmm/sec/ram/EgovRole.do";
		}
	}
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/cmm/sec/ram/EgovRoleDelete.do")
	public String deleteRole(@ModelAttribute("roleManage") RoleManage roleManage,
    	...
    	return "forward:/cmm/sec/ram/EgovRoleList.do";
	 ...
	 * @exception Exception
	 */   
	@RequestMapping(value="/cmm/sec/ram/EgovRoleListDelete.do")
