...
public class EgovAuthorGroupController {
	 ...
	 * @exception Exception
	 */
    @RequestMapping("/cmm/sec/ram/EgovAuthorGroupListView.do")
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/cmm/sec/ram/EgovAuthorGroupList.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value="/cmm/sec/ram/EgovAuthorGroupInsert.do")
	public String insertAuthorGroup(@RequestParam("userIds") String userIds,
		...
		return "forward:/cmm/sec/ram/EgovAuthorGroupList.do";
	}
	 ...
	 * @exception Exception
	 */ 
	@RequestMapping(value="/cmm/sec/ram/EgovAuthorGroupDelete.do")
