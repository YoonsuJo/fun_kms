...
public class EgovEntrprsManageController {
     ...
     * @param model 화면모델
     * @return cmm/uss/umt/EgovEntrprsMberInsert
     * @throws Exception
     */
    @RequestMapping("/uss/umt/entrprs/EgovEntrprsMberInsertView.do")
     ...
     * @param model           화면모델
     * @return forward:/uss/umt/entrprs/EgovEntrprsMberManage.do
     * @throws Exception
     */
    @RequestMapping("/uss/umt/entrprs/EgovEntrprsMberInsert.do")
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/umt/entrprs/EgovEntrprsMberSelectUpdtView.do")
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/umt/entrprs/EgovEntrprsMberSelectUpdt.do")
     ...
     * @param userSearchVO 조회조건정보
     * @param model 화면모델
     * @return "forward:/uss/umt/entrprs/EgovUserManage.do"
     * @throws Exception
     */
    @RequestMapping("/uss/umt/entrprs/EgovEntrprsMberDelete.do")
     ...
     * @param userSearchVO 검색조건정보
     * @param model 화면모델
     * @return cmm/uss/umt/EgovEntrprsMberManage
     * @throws Exception
     */
    @RequestMapping(value="/uss/umt/entrprs/EgovEntrprsMberManage.do")
     ...
     * @return cmm/uss/umt/EgovEntrprsPasswordUpdt
     * @throws Exception
     */
    @RequestMapping(value="/uss/umt/entrprs/EgovEntrprsPasswordUpdt.do")
     ...
     * @throws Exception
     */
    @RequestMapping(value="/uss/umt/entrprs/EgovEntrprsPasswordUpdtView.do")
    public String updatePasswordView(
    	...
    	model.addAttribute("userManageVO", entrprsManageVO);
        model.addAttribute("userSearchVO", userSearchVO);
    	return "cmm/uss/umt/EgovEntrprsPasswordUpdt";
    }
