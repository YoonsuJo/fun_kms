...
DELIMITER //
CREATE FUNCTION `FN_CREATE_ORGAN_FNM`(argOrgnztId VARCHAR(20)) RETURNS varchar(500)  
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_CREATE_ORGAN_FNM2`(argOrgnztId VARCHAR(20)) RETURNS varchar(500)  
BEGIN
DECLARE orgnztFullNm VARCHAR(500);    
DECLARE orgnztNm VARCHAR(100);
DECLARE prntOrgnztId VARCHAR(100);
...
DELIMITER //
CREATE FUNCTION `FN_CREATE_PRJ_CD`($prjId VARCHAR(20)) RETURNS varchar(500)  
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_DATE_LIST`($sDate CHAR(8), $eDate CHAR(8)) RETURNS text  
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_DEFAULT_PRJ_ID`($ORGNZT_ID CHAR(20)) RETURNS char(20)  
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_GET_BUDGET_PRJ`($prjId VARCHAR(20)) RETURNS varchar(20)  
BEGIN    
...
DELIMITER //
CREATE FUNCTION `FN_GET_COMPID_HISTORY`($USER_NO INT, $yyyymmdd CHAR(8)) RETURNS varchar(20)  
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_GET_COMPNM_HISTORY`($USER_NO INT, $yyyymmdd CHAR(8)) RETURNS varchar(60)  
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_GET_DATE`($yyyymm CHAR(6), $d INT) RETURNS char(8)  
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_GET_DECIDER`($templtId char(20),$userNo int(11)) RETURNS varchar(1000)  
BEGIN
    DECLARE $rule1 int;
    DECLARE $rule2 INT;
    DECLARE $rule3 INT;
...
DELIMITER //
CREATE FUNCTION `FN_GET_MEMBER_ABSENT_PERIOD`($USER_NO INT) RETURNS varchar(4)  
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_GET_MEMBER_AGE`($USER_NO INT, $yyyymmdd CHAR(8)) RETURNS varchar(4)  
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_GET_MEMBER_AGE_KOR`($USER_NO INT, $yyyymmdd CHAR(8)) RETURNS varchar(4)  
BEGIN
	DECLARE result VARCHAR(4) DEFAULT '';
	IF($yyyymmdd = '')
	THEN 
...
DELIMITER //
CREATE FUNCTION `FN_GET_MEMBER_WORK_PERIOD`($USER_NO INT) RETURNS varchar(4)  
BEGIN
	DECLARE result VARCHAR(4) DEFAULT '';
...
DELIMITER //
CREATE FUNCTION `FN_GET_ORGID_HISTORY`($USER_NO INT, $yyyymmdd CHAR(8)) RETURNS char(20)  
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_GET_ORGNM_HISTORY`($USER_NO INT, $yyyymmdd CHAR(8)) RETURNS varchar(500)  
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_GET_POSITIONNM_HISTORY`($USER_NO INT, $yyyymmdd CHAR(8)) RETURNS varchar(200)  
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_GET_POSITION_HISTORY`($USER_NO INT, $yyyymmdd CHAR(8)) RETURNS char(1)  
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_GET_RANKID_HISTORY`($USER_NO INT, $yyyymmdd CHAR(8)) RETURNS char(20)  
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_GET_RANKNM_HISTORY`($USER_NO INT, $yyyymmdd CHAR(8)) RETURNS varchar(60)  
BEGIN
	DECLARE result VARCHAR(60) DEFAULT '';
...
DELIMITER //
CREATE FUNCTION `FN_IS_AT_WORK`($userNo INT, $dt CHAR(8)) RETURNS char(1)  
BEGIN
	DECLARE $result CHAR(1) DEFAULT 'N';
	SELECT
...
DELIMITER //
CREATE FUNCTION `FN_IS_HOLIDAY`($searchDate VARCHAR(8)) RETURNS char(1)  
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_IS_PRNT`($prntId VARCHAR(20), $childId VARCHAR(20)) RETURNS char(1)  
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_IS_PRNT_ARR`($prntArr VARCHAR(400), $childId VARCHAR(20)) RETURNS char(1)  
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_MISSION_TREE`(Arg_TagId VARCHAR(25)) RETURNS varchar(500)  
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_ORGAN_LOW_TREE`(Arg_TagId VARCHAR(20)) RETURNS TEXT   
BEGIN

  DECLARE done INT DEFAULT 0;
  DECLARE vLowerId VARCHAR(20);
  DECLARE vLowerIdPath TEXT ;
...
DELIMITER //
CREATE FUNCTION `FN_ORGAN_LOW_TREE2`(Arg_TagId VARCHAR(20)) RETURNS TEXT   
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_ORGAN_LOW_TREE3`(Arg_TagId VARCHAR(20)) RETURNS TEXT   
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_ORGAN_TREE`(Arg_TagId VARCHAR(20)) RETURNS varchar(500)  
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_ORGAN_TREE_ORD`(Arg_TagId VARCHAR(20)) RETURNS varchar(500)  
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_ORGAN_TREE_UP`(Arg_TagId VARCHAR(20)) RETURNS varchar(500)  
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_PRJ_TREE`(Arg_TagId VARCHAR(20)) RETURNS varchar(500)  
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_PRJ_TREE_ORD`(Arg_TagId VARCHAR(20)) RETURNS varchar(500)  
BEGIN
...
DELIMITER //
CREATE FUNCTION `FN_TREE_PATH`(Arg_TagId VARCHAR(20)) RETURNS varchar(500)  
BEGIN
...
) ENGINE=InnoDB AUTO_INCREMENT=92947  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=166949  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=31571  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=75078  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=75361  ;
...
CREATE TABLE IF NOT EXISTS `hm_request_receive` (
  ...
  KEY `USER_NO` (`USER_NO`),
  KEY `REQ_ID` (`REQ_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=87372  ;
...
CREATE TABLE IF NOT EXISTS `hm_request_task` (
  ...
  PRIMARY KEY (`NO`)
) ENGINE=InnoDB AUTO_INCREMENT=870  ;
...
CREATE TABLE IF NOT EXISTS `tbl_bond_collection` (
  ...
  KEY `NewIndex2` (`USE_AT`)
) ENGINE=InnoDB AUTO_INCREMENT=15306  ;
...
CREATE TABLE IF NOT EXISTS `tbl_bond_expense` (
  ...
  KEY `NewIndex2` (`USE_AT`)
) ENGINE=InnoDB AUTO_INCREMENT=54675  ;
...
CREATE TABLE IF NOT EXISTS `tbl_bond_prj` (
  ...
  KEY `NewIndex2` (`PRJ_ID`),
  KEY `NewIndex3` (`USE_AT`)
) ENGINE=InnoDB AUTO_INCREMENT=55087  ;
...
CREATE TABLE IF NOT EXISTS `tbl_business_contact_comment` (
  ...
  PRIMARY KEY (`NO`),
  KEY `NewIndex1` (`BC_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=196049  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=884931  ;
...
DELIMITER //
CREATE TRIGGER before_insert_tbl_call
BEFORE INSERT ON tbl_call
FOR EACH ROW
BEGIN
	SET NEW.REG_DATETIME = IFNULL(NEW.REG_DATETIME, NOW());
	SET NEW.MOD_DATETIME = IFNULL(NEW.MOD_DATETIME, NOW());
END;
//
DELIMITER ;
...
DELIMITER //
CREATE TRIGGER before_update_tbl_call
BEFORE UPDATE ON tbl_call
FOR EACH ROW
...
DELIMITER //
CREATE TRIGGER before_insert_tbl_call_interest
BEFORE INSERT ON tbl_call_interest
FOR EACH ROW
SET NEW.REG_DATETIME = IFNULL(NEW.REG_DATETIME, NOW());
//
DELIMITER ;
...
DELIMITER //
CREATE TRIGGER before_update_tbl_call_interest
BEFORE UPDATE ON tbl_call_interest
FOR EACH ROW
...
) ENGINE=InnoDB AUTO_INCREMENT=295113  ;

DELIMITER //
CREATE TRIGGER before_insert_tbl_call_reply
BEFORE INSERT ON tbl_call_reply
FOR EACH ROW
SET NEW.REG_DATETIME = IFNULL(NEW.REG_DATETIME, NOW());
//
DELIMITER ;
...
DELIMITER //
CREATE TRIGGER before_update_tbl_call_reply
BEFORE UPDATE ON tbl_call_reply
FOR EACH ROW
SET NEW.REG_DATETIME = NOW();
//
DELIMITER ;
...
CREATE TABLE IF NOT EXISTS `tbl_call_user` (
  ...
  `NO` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`NO`)
) ENGINE=InnoDB AUTO_INCREMENT=249039   ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS `tbl_card_history` (
  ...
  KEY `ST_DT_IDX` (`ST_DT`),
  KEY `USER_NO` (`USER_NO`)
) ENGINE=InnoDB AUTO_INCREMENT=1233  ;
...
CREATE TABLE IF NOT EXISTS `tbl_card_spend` (
  ...
  KEY `STATUS` (`STATUS`)
) ENGINE=InnoDB AUTO_INCREMENT=109474  ;
...
CREATE TABLE IF NOT EXISTS `tbl_career` (
  ...
  `USER_NO` int(11) DEFAULT NULL,
  PRIMARY KEY (`CNO`)
) ENGINE=InnoDB AUTO_INCREMENT=792  ;
...
CREATE TABLE IF NOT EXISTS `tbl_career_edu` (
  ...
  PRIMARY KEY (`NO`),
  KEY `NewIndex1` (`USER_NO`)
) ENGINE=InnoDB AUTO_INCREMENT=4570  ;
...
CREATE TABLE IF NOT EXISTS `tbl_career_license` (
  ...
  PRIMARY KEY (`NO`)
) ENGINE=InnoDB AUTO_INCREMENT=3418  ;
...
CREATE TABLE IF NOT EXISTS `tbl_career_skill` (
  ...
  `USER_NO` int(11) DEFAULT NULL COMMENT 'FK',
  PRIMARY KEY (`NO`)
) ENGINE=InnoDB AUTO_INCREMENT=24090  ;
...
CREATE TABLE IF NOT EXISTS `tbl_career_train` (
  ...
  `USER_NO` int(11) DEFAULT NULL COMMENT 'FK',
  PRIMARY KEY (`NO`)
) ENGINE=InnoDB AUTO_INCREMENT=1486  ;
...
CREATE TABLE IF NOT EXISTS `tbl_career_work` (
  ...
  `USER_NO` int(11) DEFAULT NULL COMMENT 'FK',
  PRIMARY KEY (`NO`)
) ENGINE=InnoDB AUTO_INCREMENT=6260  ;
...
CREATE TABLE IF NOT EXISTS `tbl_car_reservation` (
  ...
  KEY `NewIndex6` (`ST_TM`),
  KEY `NewIndex7` (`ED_TM`)
) ENGINE=InnoDB AUTO_INCREMENT=2333  ;
...
CREATE TABLE IF NOT EXISTS `tbl_consult` (
  ...
  `Q_CN` TEXT  DEFAULT NULL COMMENT '문의내용',
  `A_CN` TEXT  DEFAULT NULL COMMENT '답변내용',
  ...
  `S_CN` TEXT  DEFAULT NULL COMMENT '특이사항',
  `user_nm` varchar(20) DEFAULT NULL COMMENT '작성자',
  `user_list` TEXT  DEFAULT NULL COMMENT '담당자들',
  `file_nm` varchar(200) DEFAULT NULL,
  `real_file_nm` varchar(200) DEFAULT NULL,
  `user_list2` TEXT  DEFAULT NULL COMMENT '참조자들',
...
) ENGINE=InnoDB AUTO_INCREMENT=3444   COMMENT='상담관리';
...
CREATE TABLE IF NOT EXISTS `tbl_consult_comment` (
  ...
  PRIMARY KEY (`NO`),
  KEY `consult_no` (`CONSULT_NO`)
) ENGINE=InnoDB AUTO_INCREMENT=57971   COMMENT='상담관리 댓글';
...
CREATE TABLE IF NOT EXISTS `tbl_consult_customer` (
  ...
  PRIMARY KEY (`NO`)
) ENGINE=InnoDB AUTO_INCREMENT=2958   COMMENT='상담관리 고객사';
...
CREATE TABLE IF NOT EXISTS `tbl_consult_recieve` (
  ...
  KEY `user_no` (`USER_NO`),
  KEY `consult_no` (`CONSULT_NO`)
) ENGINE=InnoDB AUTO_INCREMENT=1268670   COMMENT='상담관리 담당자/참조자';
...
) ENGINE=InnoDB AUTO_INCREMENT=300304  ;
...
CREATE TABLE IF NOT EXISTS `tbl_eapp_comment` (
  ...
  PRIMARY KEY (`NO`),
  KEY `NewIndex1` (`DOC_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=514243  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=7123  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=734446  ;
...
CREATE TABLE IF NOT EXISTS `tbl_eapp_user_input` (
  ...
  KEY `NewIndex3` (`ST_DT`),
  KEY `NewIndex4` (`ED_DT`)
) ENGINE=InnoDB AUTO_INCREMENT=46704  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=1555  ;
...
CREATE TABLE IF NOT EXISTS `tbl_equip_detail` (
  ...
  PRIMARY KEY (`IDX`)
) ENGINE=InnoDB AUTO_INCREMENT=7359  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=496  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=132662  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=39537  ;
...
CREATE TABLE IF NOT EXISTS `tbl_meeting_room_comment` (
  ...
  KEY `NewIndex1` (`USER_NO`),
  KEY `MT_ID` (`MT_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=7978  ;
...
CREATE TABLE IF NOT EXISTS `tbl_meeting_room_recieve` (
  ...
  KEY `NewIndex1` (`USER_NO`),
  KEY `MT_ID` (`MT_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=71198  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=569  ;
...
CREATE TABLE IF NOT EXISTS `tbl_mobile_login_log` (
  ...
  PRIMARY KEY (`NO`),
  KEY `NewIndex1` (`USER_NO`)
) ENGINE=InnoDB AUTO_INCREMENT=1396  ;
...
CREATE TABLE IF NOT EXISTS `tbl_mymenu` (
  ...
  PRIMARY KEY (`NO`)
) ENGINE=InnoDB AUTO_INCREMENT=1255  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=428591  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=612  ;
...
CREATE TABLE IF NOT EXISTS `tbl_prj_input` (
  ...
  KEY `NewIndex1` (`PRJ_ID`),
  KEY `NewIndex2` (`USER_NO`)
) ENGINE=InnoDB AUTO_INCREMENT=1213865  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=2746  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=154869  ;
...
CREATE TABLE IF NOT EXISTS `tbl_purchase_in_labor` (
  ...
  KEY `NewIndex5` (`PURCHASE_IN_DT`),
  KEY `NewIndex6` (`DECIDE_YN`)
) ENGINE=InnoDB AUTO_INCREMENT=509608  ;
...
CREATE TABLE IF NOT EXISTS `tbl_purchase_out` (
  ...
  KEY `NewIndex4` (`DECIDE_YN`)
) ENGINE=InnoDB AUTO_INCREMENT=47189  ;
...
CREATE TABLE IF NOT EXISTS `tbl_push_log` (
  ...
  PRIMARY KEY (`no`)
) ENGINE=InnoDB AUTO_INCREMENT=376276  ;
...
CREATE TABLE IF NOT EXISTS `tbl_sales` (
  ...
  KEY `NewIndex4` (`DECIDE_YN`)
) ENGINE=InnoDB AUTO_INCREMENT=66083  ;
...
CREATE TABLE IF NOT EXISTS `tbl_score_detail` (
  ...
  KEY `NewIndex2` (`USER_NO`)
) ENGINE=InnoDB AUTO_INCREMENT=27324  ;
...
CREATE TABLE IF NOT EXISTS `tbl_scrap` (
  ...
  PRIMARY KEY (`NO`),
  KEY `NewIndex1` (`USER_NO`)
) ENGINE=InnoDB AUTO_INCREMENT=331  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=1571  ;
...
CREATE TABLE IF NOT EXISTS `tbl_stock_item` (
  ...
  `use_at` char(1) DEFAULT 'Y' COMMENT '해당 레코드 사용여부(Y:사용, N:삭제)',
  PRIMARY KEY (`no`)
) ENGINE=InnoDB AUTO_INCREMENT=9007  ;
...
CREATE TABLE IF NOT EXISTS `tbl_task_content` (
  ...
  KEY `NewIndex2` (`USER_NO`)
) ENGINE=InnoDB AUTO_INCREMENT=450  ;
...
CREATE TABLE IF NOT EXISTS `tbl_task_history` (
  ...
  `HISTORY_CN` text DEFAULT NULL COMMENT '변경 내용',
  PRIMARY KEY (`HISTORY_NO`)
) ENGINE=InnoDB AUTO_INCREMENT=79377  ;
...
) ENGINE=InnoDB AUTO_INCREMENT=595  ;
...
CREATE TABLE IF NOT EXISTS `tbl_userinfo_military` (
  ...
  PRIMARY KEY (`NO`)
) ENGINE=InnoDB AUTO_INCREMENT=802  ;
...
CREATE TABLE `v_eapp_exp` (
	`EXP_ID` VARCHAR(20) NULL ,
	`DOC_ID` VARCHAR(20) NULL ,
	`PRESET_ID` VARCHAR(20) NULL ,
	`EXP_SPEND_TYP` VARCHAR(2) NULL ,
	`PAYING_DUE_DATE` VARCHAR(8) NULL ,
	`ACC_ID` VARCHAR(20) NULL ,
	`EXP_DT` VARCHAR(8) NULL ,
	`EXP_SPEND` BIGINT(20) NULL,
	`PRJ_ID` VARCHAR(20) NULL ,
	`COMPANY_CD` VARCHAR(10) NULL ,
	`EXP_CT` MEDIUMTEXT NULL ,
	`CARD_SPEND_NO` INT(11) NULL,
	`COLUMN1` VARCHAR(500) NULL ,
	`COLUMN2` VARCHAR(500) NULL ,
	`BUDGET_PRJ` VARCHAR(20) NULL 
) ENGINE=MyISAM;

CREATE TABLE `v_eapp_exp_card` (
	`CARD_SPEND_NO` INT(11) NULL,
	`DOC_ID` VARCHAR(20) NULL ,
	`DOC_STAT` VARCHAR(10) NULL COMMENT 'APP000 기안대기(저장문서) APP001 검토중 APP002 협조중 APP003 전결중 APP004 참조중 APP005 완료 else(APP099) 결재실패' ,
	`NEW_AT` CHAR(1) NULL COMMENT '유효성 : 0 - 무효 1 - 유효' 
) ENGINE=MyISAM;
...
CREATE TABLE `v_org_head_bak` (
	...
	`USER_NM` VARCHAR(60) NULL COMMENT 'Name' ,
	`USER_ID` VARCHAR(20) NULL COMMENT 'ID' ,
	`POSITION` CHAR(1) NULL COMMENT '보직 // H:부서장 S:부서장대행 N:일반' 
) ENGINE=MyISAM;

CREATE TABLE `v_prj_tree` (
	`ID` VARCHAR(20) NOT NULL ,
	`NM` VARCHAR(100) NULL ,
	`PRNT` VARCHAR(20) NULL ,
	`SN` VARCHAR(2000) NULL ,
	`SN_ORD` VARCHAR(2000) NULL ,
	`LV` BIGINT(11) NULL,
	`TYP` VARCHAR(3) NOT NULL ,
	`ST_DT` VARCHAR(8) NULL ,
	`COMP_DT` VARCHAR(8) NULL ,
	`COMP_DUE_DT` VARCHAR(8) NULL ,
	`STAT` CHAR(1) NULL ,
	`PRJ_TYPE` VARCHAR(1) NULL ,
...
CREATE TABLE `v_purchase_in` (
	...
	`DOC_ID` VARCHAR(20) NULL ,
	`PURCHASE_PRJ_ID` VARCHAR(20) NULL ,
	`SALES_PRJ_ID` VARCHAR(20) NULL ,
	`TYP` VARCHAR(10) NULL ,
	`PURCHASE_IN_DT` INT(11) NULL,
	`COST` BIGINT(20) NULL,
	`PURCHASE_IN_CT` MEDIUMTEXT NULL ,
	`DECIDE_YN` CHAR(1) NULL ,
...
CREATE TABLE `v_userinfo_bak` (
	...
	`USER_ID` VARCHAR(20) NOT NULL COMMENT 'ID' ,
	`USER_NM` VARCHAR(60) NOT NULL COMMENT 'Name' ,
	`USER_ENM` VARCHAR(60) NULL COMMENT 'English Name' ,
	`PASSWORD` VARCHAR(100) NOT NULL COMMENT 'PW' ,
	`SABUN` CHAR(4) NULL COMMENT '사번' ,
	`IHIDNUM` CHAR(13) NULL COMMENT '주민번호' ,
	`SEXDSTN_CODE` CHAR(1) NULL COMMENT '성별 - 미사용' ,
	`BRTH` CHAR(8) NULL COMMENT '생일' ,
	`GRE_LUN` CHAR(1) NULL COMMENT 'G 양력(그레고리안) L 음력(루나)' ,
	`HOME_ADRES` VARCHAR(100) NULL COMMENT '주소' ,
	`MOBLPHON_NO` VARCHAR(30) NULL COMMENT '이동전화' ,
	`HOME_TELNO` VARCHAR(30) NULL COMMENT '집전화' ,
	`OFFM_ID` VARCHAR(20) NULL COMMENT '사무실번호 - 미사용' ,
	`OFFM_TELNO` VARCHAR(15) NULL COMMENT '사무실전화번호' ,
	`OFFM_TELNO_INNER` VARCHAR(15) NULL COMMENT '내선번호' ,
	`EMAIL_ADRES` VARCHAR(50) NULL COMMENT '회사메일' ,
	`EMAIL_ADRES2` VARCHAR(50) NULL COMMENT '외부메일' ,
	`EXP_COMP_ID` VARCHAR(20) NULL COMMENT '지출결의회사' ,
	`COMPNY_ID` VARCHAR(20) NULL COMMENT '소속회사' ,
	`ORGNZT_ID` CHAR(20) NULL COMMENT '소속조직' ,
	`RANK_ID` CHAR(20) NULL COMMENT '직급' ,
	`POSITION` CHAR(1) NULL COMMENT '보직 // H:부서장 S:부서장대행 N:일반' ,
	`COMPIN_DT` VARCHAR(8) NULL COMMENT '입사일' ,
	`COMPOT_DT` VARCHAR(8) NULL COMMENT '퇴사일' ,
	`WORK_ST` CHAR(1) NULL COMMENT 'W:근무 L:휴직 R:퇴직' ,
	`CAR_ID` VARCHAR(20) NULL COMMENT '소유차량 등록번호' ,
	`CAR_LIC_TYP` VARCHAR(10) NULL COMMENT 'A:1종대형 B:1종보통 C:2종자동' ,
	`ABUTME` TEXT NULL COMMENT '자기소개' ,
	`PIC_FILE_ID` CHAR(20) NULL COMMENT '소개사진' ,
	`PIC_FILE_ID2` CHAR(20) NULL COMMENT '증명사진' ,
	`ADMIN_NOTE` TEXT NULL COMMENT '비고란' ,
	`GHOST` TINYINT(1) NOT NULL COMMENT '고스트 속성',
	`SHOW_RIGHT` TINYINT(1) NULL COMMENT '우측메뉴 보임/숨김',
	`DAY_REPORT_TYP` CHAR(1) NULL COMMENT 'B(rief), D(etail)' 
) ENGINE=MyISAM;
